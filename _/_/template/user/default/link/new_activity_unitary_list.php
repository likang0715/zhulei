...
<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
    ...
    <tr>
        <td><p style="max-width:200px;"><?php echo $v['name'] ?></p></td>
        <td><img src="<?php echo $v['logopic'] ?>" style="width:80px;height:80px;"></td>
        <td><a href="javascript:void(0)" onclick="returnHomepage('<?php echo option("config.site_url")."/webapp/snatch/#/main/".$v['id']; ?>')" style="margin-left:14px;">选中</a></td>
    </tr>
    <?php } ?>
    </tbody>
</table>
...
<script>
    ...
    $(".pages a").live("click", function () {
        ...
        location.href="<?php echo option("config.site_url")."/user.php?c=link&a=new_activity_list&module=unitary&store_id=".$_REQUEST['store_id']."&p=";?>"+p;
    })
</script>
</body>
</html>