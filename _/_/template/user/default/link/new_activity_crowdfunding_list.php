...
<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
    ...
    <tr>
        ...
        <td><a href="javascript:void(0)" onclick="returnHomepage('<?php echo option("config.site_url")."/webapp/chanping/index.html#/view/".$v['product_id']; ?>')" style="margin-left:14px;">选中</a></td>
    </tr>
    <?php } ?>
    </tbody>
</table>
