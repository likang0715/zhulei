				...
				<div class="presale-info">
					<div class="js-basic-info-region">
						<div class="control-group">
							...
							<div class="controls">
								<div class="checkbox game_type" id="game_type">
									<label><input type="checkbox" value="1">大转盘</label>
									<label><input type="checkbox" value="2">九宫格</label>
									<label><input type="checkbox" value="3">刮刮卡</label>
									<label><input type="checkbox" value="4">水果机</label>
									<label><input type="checkbox" value="5">砸金蛋</label>
								</div>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="start_time" value=""/>&nbsp;&nbsp;<input type="text" id="end_time" value=""/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">
							...
							<div class="controls">
								<textarea class="form-control" rows="3" id="active_desc"></textarea>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">
						...
						<div class="control-group">
							...
							<div class="controls">
								<ul class="ico app-image-list js-logo">
									...
									<input type="hidden" name="info[backgroundThumImage]" value="" id="backgroundThumImage">
									</li>
								</ul>
								...
								<div class="clear controls" style="margin-left:56px;">
									...
									<div class="radio controls game_type" id="fill_type">
										<label><input type="radio" name="fill_type" checked value='1' />平铺</label>
										<label><input type="radio" name="fill_type" value="0"/>填充</label>
									</div>
								</div>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls game_type" id="isshow_num">
								<label><input type="radio" name="isshow_num" value='1' />是</label>
								<label><input type="radio" name="isshow_num" checked value="0"/>否</label>
							</div>
						</div>
					</div>
					<div class="control-group">
					...
					<input type="hidden" id="anwei_id" value="0"/>
					<?php 
					...
					<div class="control-group">
						<div class="control-group" style="display: none;" id="div_product_select_<?php echo $key;?>">
							<input type="hidden" name="product_id" id="product_id_<?php echo $key;?>" value="0">
							<input type="hidden" name="sku_id" id="sku_id_<?php echo $key;?>" value="0">
							<label class="control-label">
						...
						<div class="control-group" style="display:none;" id="div_coupon_select_<?php echo $key;?>">
							...
							<div class="controls">
								<select class="js-reward-coupon" id="coupon_<?php echo $key;?>" style="width: 180px;" onclick="change_coupon(this,<?php echo $key;?>)">
									...
									?>
										<option value="<?php echo $coupon['id'] ?>" val="<?php echo htmlspecialchars($coupon['name']) ?>"><?php echo htmlspecialchars($coupon['name']) ?></option>
									<?php 
									}
						...
						<div class="controls">
							<input type="text" id="product_name_<?php echo $key;?>" placeholder="积分名称" />
							<input type="text" style="display:none;width:100px;" id="product_recharge_<?php echo $key;?>" placeholder="实际奖励的积分数值"/>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<input type="text" id="product_num_<?php echo $key;?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<input type="text" id="rates_<?php echo $key;?>" />
					...
					<div class="control-group">
						...
						<div class="controls" style="margin-left:30px;" id="div_win_limits">
							<div class="control-group">
								<div class="radio">
									<label style="margin-left:134px;"><input type="radio" name="win_limit" checked value="0">不限制</label>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">&nbsp;</label>
								<div class="radio">
									<label style="width:80px;float:left;"><input type="radio" name="win_limit" value="1">每日限制</label>
									<span>一日</span><input type="text" style="width:50px" id="day_limit_num"/>次，
									分享<input type="text" style="width:50px" id="share_limit_num"/>次，增加一次机会
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">&nbsp;</label>
								<div class="radio">
									<label style="width:80px;float:left;"><input type="radio" name="win_limit" value="3">积分限制</label>
									<span>一次</span><input type="text" style="width:50px" id="recharge_limit_num"/>积分
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">&nbsp;</label>
								<div class="checkbox">
									<label><input type="checkbox" id="need_subscribe">需要用户关注参与</label>
								</div>
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls" id="div_win_type">
							<div class="control-group">
								<label style="float:left;width:80px;"><input type="radio" name="win_type" value="0"/>总次数</label>
								<input type="text" style="width:100px;float:left" />
							</div>
							<label class="control-label">&nbsp;</label>
							<div class="control-group">
								<label style="float:left;width:80px;"><input type="radio" name="win_type" value="1"/>单日次数</label>
								<input type="text" style="width:100px;float:left" />
							</div>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="win_password" />
						</div>
					</div>
...
<script type="text/javascript">
	...
	function save(){
		...
		console.log(data);
		$.post('/user.php?c=lottery&a=save',{'data':data},function(response){
	...
	function checkPrizeData(data){
		...
		/*if(data.backgroundThumImage==''){
			result.err_code = 1;result.err_msg='请上传活动背景图';
			return result;
		}*/
