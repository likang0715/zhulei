 ...
 */
$(function(){
    load_page('.app__content', load_url, {page:'bond_record_content','store_id':store_id}, '', function(){
    ...
    $('.ui-nav > ul > li').live('click', function() {
        ...
        load_page('.app__content', load_url, {page:'bond_record_content', 'status': status, 'store_id': store_id }, '', function(){
    ...
    $('.pagenavi > a').live('click', function(e){
        ...
        $('.app__content').load(load_url, {page: 'bond_record_content', 'p':p, 'keyword': keyword, 'store_id':store_id,'status':status}, function(){
            if (keyword != '') {
    ...
    $('.ui-btn-primary').live('click', function(){
        ...
        var status = $.trim($('.status').data('status'));
        load_page('.app__content', load_url, {page: 'bond_record_content', 'order_no': keyword,'store_id':store_id,'status':status}, '', function(){
