...
function link_box(dom,typeArr,after_obj){
	...
	dom.hover(function(){
		if(dom.find('.dropdown-menu').size() == 0){
			if(typeArr.length == 0){
				domHtml = $('<ul class="dropdown-menu" style="display:block;"><li><a data-type="page" href="javascript:;">微页面及分类</a></li><li><a data-type="good" href="javascript:;">商品及分组</a></li><li><a data-type="checkin" href="javascript:;">我要签到</a></li><li><a data-type="home" href="javascript:;">店铺主页</a></li><li><a data-type="ucenter" href="javascript:;">会员主页</a> </li><li> <a data-type="diancha" href="javascript:;">点茶预约</a></li><li><a data-type="subject_type" href="javascript:;">专题分类展示</a> </li><li style="display:none"><a data-type="tuan" href="javascript:;">团购主页</a> </li><li style="display:none"><a data-type="yydb" href="javascript:;">一元夺宝主页</a> </li><li> <a data-type="link" href="javascript:;">自定义外链</a></li></ul>');
			}else{
