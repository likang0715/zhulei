...
$(function(){
    ...
    var tmp_status = '*';
    courier_id = $("input[name=courier_id]").val();
    load_page('.app__content', load_url,{page:'courier_package_content', 'p': page, 'orderbyfield': orderbyfield, 'orderbymethod': orderbymethod, 'status': tmp_status, 'courier_id': courier_id}, '', function(){
    ...
    $('.ui-nav > ul > li > a').live('click', function(){
        ...
        load_page('.app__content', load_url,{page:'courier_package_content', 'p': page, 'orderbyfield': orderbyfield, 'orderbymethod': orderbymethod, 'status': status, 'courier_id': courier_id}, '', function(){
