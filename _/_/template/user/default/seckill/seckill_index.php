...
<head>
    <meta charset="utf-8"/>
    <title>秒杀 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <link href="<?php echo TPL_URL;?>css/seckill.css" type="text/css" rel="stylesheet"/>
    ...
    <script type="text/javascript">
        ...
        var seckill_disabled_url = "<?php dourl('seckill:disabled') ?>";
        var seckill_add_url = "<?php dourl('seckill:add') ?>";
        var seckill_edit_url = "<?php dourl('seckill:edit') ?>";
        var seckill_delete_url = "<?php dourl('seckill:delete') ?>";
        var seckill_over_url = "<?php dourl('seckill:over') ?>";
        var seckill_wap_url = "<?php echo rtrim(option('config.site_url'),'/') ?>/wap/seckill.php?seckill_id=";
        var seckill_qrcode_url = "<?php echo option("config.site_url") ?>/source/qrcode.php?type=";
    </script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/seckill.js"></script>
</head>
