...
<div class="modal-header">
    ...
    <ul class="module-nav modal-tab">
        <li class="active"><a href="javascript:void(0);" class="js-modal-tab">预售活动</a></li>
                ...
                <?php foreach($presales as $presale){ ?>
                    <tr>
                        <td class="title" style="max-width:300px;">
                            <div class="td-cont">
                                <a target="_blank" class="new_window" href="javascript:"><?php echo $presale['name']; ?></a>
                            </div>
                        </td>
                        <td class="time">
                            <div class="td-cont">
                        ...
                        <td class="opts">
                            <div class="td-cont">
                                <button class="btn js-choose" data-id="<?php echo $presale['id'];?>" data-title="<?php echo $presale['name'];?>">选取</button>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
