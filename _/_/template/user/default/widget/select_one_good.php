						...
						<tbody>
							<?php foreach($products as $product){ ?>
								<tr>
									...
									<td class="opts">
										<div class="td-cont">
											<button class="btn js-choose" data-id="<?php echo $product['product_id'];?>" data-title="<?php echo $product['name']; ?>" data-price="<?php echo $product['price']; ?>" data-image="<?php echo $product['image'];?>" data-logoimg1="<?php echo $product['logoimg1']; ?>" data-logoimg2="<?php echo $product['logoimg2']; ?>" data-logoimg3="<?php echo $product['logoimg3']; ?>" data-inventory="<?php echo $product['quantity'];?>">选取</button>
										</div>
									</td>
								</tr>
							<?php } ?>
