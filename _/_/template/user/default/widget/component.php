		...
		<script type="text/javascript">
			$(function(){
				...
				$('button.js-choose').live('click',function(){
					parent.login_box_after('<?php echo $_GET['number'];?>',$(this).data('id'),$(this).data('title'),'<?php dourl('case:page') ?>#edit/'+$(this).data('id'));
				});
							...
							<?php foreach($pages as $value){ ?>
								<tr>
									<td class="title" style="max-width:300px;">
										<div class="td-cont">
											<a target="_blank" class="new_window" href="<?php dourl('case:page') ?>#edit/<?php echo $value['page_id'];?>"><?php echo $value['name']; ?></a>
										</div>
									</td>
									<td class="time">
										<div class="td-cont">
