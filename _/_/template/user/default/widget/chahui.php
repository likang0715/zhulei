			...
			$(function(){
				...
				$('.js-page-list a').live('click',function(e){
					if(!$(this).hasClass('active')){
						...
						$('body').load('<?php dourl('good',array('type'=>'more'));?>',{p:$(this).data('page-num'),'keyword':input_val, 'no_group' : '<?php echo $_REQUEST['no_group'] ?>'},function(){
							$('.js-modal iframe',parent.document).height($('body').height());
						});
					}
				});
				$('.js-modal-search').live('click',function(e){
					var input_val = $('.js-modal-search-input').val();
					$('body').html('<div class="loading-more"><span></span></div>');
					$('body').load('<?php dourl('good',array('type'=>'more'));?>',{'keyword':input_val, 'no_group' : '<?php echo $_REQUEST['no_group'] ?>'},function(){
						$('.js-modal iframe',parent.document).height($('body').height());
					});
					return false;
				});
	...
	<body style="background-color:#ffffff;">
		<div class="modal-header">
			...
			<!-- <ul class="module-nav modal-tab">
				...
				<?php 
				if ($_REQUEST['no_group'] != 'no_group') {
				?>
					<li><a href="<?php dourl('goodcat',array('number'=>$_GET['number']));?>" class="js-modal-tab">商品分组</a> |</li>
				<?php 
				}
				?>
