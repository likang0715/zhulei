	...
	<body style="background-color:#ffffff;">
		<div class="modal-header">
			...
			<ul class="module-nav modal-tab">
				<li class="active"><a href="javascript:void(0);" class="js-modal-tab">自营商品</a> </li>
			</ul>
		</div>
							...
							<?php foreach($products as $product){ ?>
								<tr>
									<td class="title" style="max-width:300px;">
										<div class="td-cont">
											<a target="_blank" class="new_window" href="<?php echo $config['wap_site_url'];?>/good.php?id=<?php echo $product['product_id'];?>" title="<?php echo $product['name']; ?>"><?php echo msubstr($product['name'],0,25,false); ?></a>
										</div>
									</td>
									<td class="time">
										<div class="td-cont">
