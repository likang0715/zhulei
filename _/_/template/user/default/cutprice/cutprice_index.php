...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>降价拍 - <?php echo $store_session['name']; ?> | <?php echo $config['site_name'];?></title>
		...
		<script type="text/javascript">
			...
			var page_content = "cutprice_list";
			var package_product_url = "<?php dourl('order:package_product') ?>";
			var page_product_list = "product_list";
			var page_cutprice_create = "create";
			var page_cutprice_edit = "edit";
			var disabled_url = "<?php dourl('disabled') ?>";
			var delete_url = "<?php dourl('delete') ?>";
			var cutprice_wap_url = "<?php echo option('config.site_url') ?>/wap/cutprice.php?action=detail&store_id=<?php echo $store_session['store_id']?>&id=";	//前台开发后修改
			var cutprice_qrcode_url = "<?php echo option("config.site_url") ?>/source/qrcode.php?type=cutprice";	//前台开发后修改
		</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/cutprice.js"></script>
	</head>
