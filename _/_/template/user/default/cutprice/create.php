			...
			<form class="form-horizontal" id="myformaaaaaaa">
				<div class="presale-info">
						...
						<div class="control-group">
							...
							<div class="controls">
								<ul class="ico app-image-list js-product" data-product_id="0">
									<li><a href="javascript:add_product()" class="add-goods js-add-picture">选商品</a></li>
								</ul>
							</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="start_price" id="start_price" value="0" style="width: 100px;" />
							<span style="padding-top: 5px; color: red;">
								起拍价不能低于最低价，不能高于原价
							</span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="low_price" id="low_price" value="0" style="width: 100px;" />
							<span style="padding-top: 5px; color: red;">
								最低价不能高于起拍价
							</span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							每<input type="text" style="width:50px;" id="minute" value=""/>分钟 下降<input type="text" style="width:50px;" id="down_price" value=""/>元
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inventory" style="width:70px;" value=""/>
							<span style="padding-top: 5px; color: red;">
					...
					<div class="control-group">
						...
						<div class="controls">
							每人限购<input type="text" id="buy_limit" style="width:70px;" value=""/>
							<span style="padding-top: 5px; color: red;">
								不填或填写0则不限制
							</span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea rows="5" cols="55" style="width:65%" name="descript" id="descript" class="descript"></textarea>
						</div>
					</div>
				</div>
			</form>
			<div class="control-group row">
				<label class="control-label" style="width:200px;float:left">
					未关注店铺公众号是否可以参与：
				</label>
				<div class="controls col-sm-3" id="issubscribe">
					<label class="radio inline"><input type="radio" name="subscribe" val="1" checked />是 </label>
					<label class="radio inline"><input type="radio" name="subscribe" val="0" />否</label>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function save(){
		...
		console.log('price='+parseFloat(data.startprice)+'  original='+data.original);
		if(parseFloat(data.startprice) > data.original){
