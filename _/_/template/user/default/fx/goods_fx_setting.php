...
<html>
	<head>
		...
		<script type="text/javascript">var load_url="<?php dourl('load');?>", product_id = "<?php echo $_GET['id']; ?>", fx_url="<?php echo dourl('goods_fx_setting', array('role' => $_GET['role'], 'type' => $_GET['type'])); ?>";var wholesale_setting_url = "<?php dourl('fx:goods_wholesale_setting');?>";</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_goods_setting.js"></script>
	</head>
