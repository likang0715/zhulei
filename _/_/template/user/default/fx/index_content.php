            ...
            myChart.setOption({
                ...
                series : [
                    ...
                    },
                    {
                        ...
                        type:'line',
                        smooth:true,
                        data: <?php echo $every_day_sellers; ?>
                    },
                    {
                        name:'分销商总数',
                        type:'line',
                        smooth:true,
                        data: <?php echo $end_today_sellers; ?>
                    }
                ]
            });
        }
    ...
    <div class="js-cont">
        <div class="info-group">
            <div class="info-group__inner">
                    <span class="h4">
                        <a href="<?php echo dourl('goods'); ?>"><?php echo $fx_product_count; ?></a>
                    </span>
                <span class="info-description">分销商品</span>
            </div>
        </div>
        <div class="info-group">
            <div class="info-group__inner">
        ...
        <div class="info-group">
            <div class="info-group__inner">
                    <span class="h4">
                        <a href="<?php echo dourl('trade:income'); ?>">￥<?php echo $unbalance; ?></a>
                    </span>
                    <span class="info-description">佣金
                        <i>-</i>
                        <a href="<?php echo dourl('trade:income'); ?>">不可提现</a></span>
            </div>
        </div>
        <div class="info-group">
            <div class="info-group__inner">
                    ...
                    <span class="info-description">
                        佣金
                        <i>-</i>
                        <a href="<?php echo dourl('trade:income'); ?>">可提现</a>
                    </span>
            </div>
        </div>
    </div>
        ...
        <div class="widget-head">
            ...
            <div class="help">
                ...
                <div class="js-notes-cont hide">
                    ...
                    <p><strong>每日新增分销商：</strong>当天新增分销商总数量。</p>
                    <p><strong>分销商总数：</strong>截止今日下级分销商数量。</p>
                </div>
            </div>
        </div>
