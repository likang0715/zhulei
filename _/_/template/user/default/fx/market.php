...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>商品市场 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">var load_url="<?php dourl('load');?>", store_id = "<?php echo $_GET['store_id']; ?>",delivery_address_url = "<?php dourl('delivery_address'); ?>", market_url = "<?php dourl('market'); ?>", soldout_url = "<?php dourl('goods:soldout'); ?>", service_url="<?php dourl('service'); ?>";</script>
