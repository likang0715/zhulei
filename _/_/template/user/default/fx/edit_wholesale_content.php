...
<div class="goods-edit-area">
    <ul class="ui-nav-tab">
        <li data-next-step="2" class="js-switch-step js-step-2 active"><a href="javascript:;">批发商品信息修改</a></li>
    </ul>
                            ...
                            <div class="group-inner">
                                ...
                                <div class="controls">
                                    <table class="freight-template-table freight-template-item">
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" style="display:<?php echo !empty($whitelist) ? 'none' : 'block'?>" data-product="<?php echo $product['product_id']; ?>" class="js-edit-cost-item">选择经销商</a></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                ...
                                <div class="group-inner">
                                        ...
                                        <div class="cost-price-1">
                                            <div class="controls">
                                                <div class="input-prepend">
                                                    <span class="add-on">￥</span><input type="text" maxlength="10" name="min_wholesale_price" class="wholesale-price-one input-small" value="<?php echo $wholesale_price; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="price-1 ">
                                            <div class="controls">
                                                <div class="input-prepend">
                                                    <span class="add-on">￥</span><input type="text" maxlength="10" name="fx-min-price" class="input-small fx-min-price" data-min-price="<?php echo $sale_min_price; ?>" value="<?php echo $sale_min_price; ?>"/> <span style="display:inline-block;margin-top:10px">-</span> <span class="add-on">￥</span><input type="text" maxlength="10" name="fx-max-price" class="fx-max-price input-small" data-max-price="<?php echo $sale_max_price; ?>" value="<?php echo $sale_max_price; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
