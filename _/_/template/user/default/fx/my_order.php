...
<head>
    <meta charset="utf-8"/>
    <title>我的订单 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", order_id=parseInt("<?php echo $order_id?>");</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_common.js"></script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_my_order.js"></script>
    <style type="text/css">
        .ui-nav {
            border: none;
            background: none;
