...
<head>
    <meta charset="utf-8"/>
    <title>分销排名 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", is="<?php echo !empty($_GET['is']) ? $_GET['is'] : 3;?>",drp_status_url="<?php dourl('drp_status');?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_common.js"></script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_distribution.js"></script>
</head>
