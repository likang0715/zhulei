                ...
                <div class="clearfix">
                    <div class="filter-groups">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fx_order_no" value="<?php echo !empty($_POST['fx_order_no']) ? $_POST['fx_order_no'] : ''; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">收货人姓名：</label>
                            <div class="controls">
                                <input type="text" name="delivery_user" value="<?php echo !empty($_POST['delivery_user']) ? $_POST['delivery_user'] : ''; ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="pull-left">
                        ...
                        <div class="filter-groups">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="delivery_tel" value="<?php echo !empty($_POST['delivery_tel']) ? $_POST['delivery_tel'] : ''; ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="filter-groups">
			...
			<div class="js-list-search">
				...
				<span style="background-color:#e5e5e5;display:inline-block;padding:2px;">
					<select id="select_level" style="margin-bottom: 0px;height: auto;line-height: normal;width: auto;font-size: 12px;font-family: Helvetica,STHeiti,'Microsoft YaHei',Verdana,Arial,Tahoma,sans-serif;">
						...
						<option value="all">导出全部经销订单</option>
					</select>
					<input type="button" class="ui-btn ui-btn-primary js-dump-btn" value="经销商订单导出">
				</span>
				</div>
			</div>
		</div>
