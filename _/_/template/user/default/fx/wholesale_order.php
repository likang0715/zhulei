...
<head>
    <meta charset="utf-8"/>
    <title>批发订单 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", pay_url = "<?php dourl('orders'); ?>",drp_checkout_url="<?php dourl('wholesale_checkout_order');?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_common.js"></script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_wholesale_order.js"></script>
</head>
