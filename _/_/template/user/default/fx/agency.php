...
<head>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", add_agency_url="<?php dourl('add_agency')?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/agency.js"></script>
    <style type="text/css">
        .ui-nav {
            border: none;
            background: none;
