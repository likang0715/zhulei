...
<div class="goods-list">
    <div class="ui-box">
        <?php if (!empty($whitelist_products)) { ?>
        <table class="ui-table ui-table-list" style="padding: 0px;">
            <thead class="js-list-header-region tableFloatingHeaderOriginal" style="position: static; top: 0px; margin-top: 0px; left: 601.5px; z-index: 1; width: 850px;">
                <tr>
                    ...
                    <th class="cell-10 text-center" style="min-width: 68px; max-width: 68px;">操作</th>
                </tr>
            </thead>
            <tbody class="js-list-body-region">
            <?php foreach ($whitelist_products as $product) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="javascript:void(0);" class="remove-whitelist" data-id="<?php echo $product['pigcms_id']; ?>">移出白名单</a>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
