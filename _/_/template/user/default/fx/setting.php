...
<head>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", service_url="<?php dourl('service'); ?>", open_drp_approve_url="<?php dourl('drp_approve'); ?>", open_drp_guidance_url="<?php dourl('drp_guidance'); ?>", open_drp_limit_url="<?php dourl('drp_limit'); ?>", open_drp_diy_store_url="<?php dourl('drp_diy_store'); ?>", open_drp_setting_price_url="<?php dourl('drp_setting_price'); ?>", save_drp_limit_url="<?php dourl('save_drp_limit'); ?>", save_unified_price_setting_url="<?php dourl('save_unified_price_setting'); ?>", open_drp_subscribe_url="<?php dourl('drp_subscribe'); ?>", open_drp_subscribe_auto_url="<?php echo dourl('drp_subscribe_auto'); ?>", drp_subscribe_tpl_url="<?php echo dourl('drp_subscribe_tpl'); ?>", reg_drp_subscribe_tpl_url="<?php echo dourl('reg_drp_subscribe_tpl'); ?>",drp_update_store_url="<?php echo dourl('drp_update_store_info'); ?>", fans_lifelong_url="<?php echo dourl('fans_lifelong'); ?>",fanshare_drp_url="<?php echo dourl('fanshare_drp'); ?>", setting_canal_qrcode_url="<?php echo dourl('setting_canal_qrcode')?>", canal_qrcode_tpl_url="<?php echo dourl('canal_qrcode_tpl')?>", open_drp_degree_url = "<?php dourl('drp_degree'); ?>", open_drp_team_url = "<?php dourl('drp_team'); ?>", drp_withdrawal_min_url = "<?php dourl('drp_withdrawal_min'); ?>", drp_product_setting_url = "<?php dourl('drp_product_setting'); ?>", load_image_url = "<?php echo TPL_URL;?>/images/loading-0.gif", success_image_url = "<?php echo TPL_URL;?>/images/success.png", last_product_id = parseInt("<?php echo $last_product_id; ?>"), custom_drp_last_product_id = parseInt("<?php echo $custom_drp_last_product_id; ?>"), products = parseInt("<?php echo $products; ?>"), custom_drp_products = parseInt("<?php echo $custom_drp_products; ?>"), edit_fx_url = "<?php dourl('fx:edit_goods'); ?>", fans_list_url = "<?php dourl('widget:fans_forever', array('type' => 'more')); ?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_setting.js"></script>
</head>
