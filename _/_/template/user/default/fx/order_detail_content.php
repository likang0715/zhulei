...
<div class="section section-express">
    <div class="section-title clearfix">
        <h2>付款给供货商 - <?php echo $supplier_order['supplier']; ?></h2>
    </div>
    <div class="section-detail">
        <table>
            <tbody>
                <tr>
                    <td>交易单号：</td>
                    <td><?php echo $supplier_order['order_no']; ?></td>
                </tr>
                <tr>
                    <td>付款金额：</td>
                    <td><strong class="ui-money-income">￥<?php echo $supplier_order['total']; ?></strong>（含运费 <?php echo $supplier_order['postage']; ?>）</td>
                </tr>
                <tr>
                    <td>付款时间：</td>
                    <td><?php echo date('Y-m-d H:i:s', $supplier_order['paid_time']); ?></td>
                </tr>
                <tr>
                    <td>付款方式：</td>
                    <td><?php if (empty($supplier_order['use_deposit_pay'])) { echo $supplier_order['payment_method'];} else { echo '保证金扣款'; } ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<div class="section section-express">
    ...
    <div class="section-detail">
        ...
        <div class="js-express-tab-content <?php if ($key > 0) { ?>hide<?php } ?>" data-pack-id="<?php echo $package['page_id']; ?>" data-express-no="<?php echo $package['express_no']; ?>">
            <p>
                <?php echo $package['express_company']; ?> 运单号：<?php echo $package['express_no']; ?>
