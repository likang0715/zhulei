...
<div class="js-app-inner app-inner-wrap hide" style="display: block;">
    ...
    <div id="js-filter" class="filter-wrap"><table>
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="js-filter-btn btn btn-primary" data-loading-text="请稍候...">筛 选</button>
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <div id="js-order-chart" class="widget widget-order-chart">
        <div class="widget-inner">
            <div class="widget-head">
                <h3 class="widget-title">“<?php echo $store['name']; ?>”分销趋势</h3>
                <div class="help">
                    <span style="color:red;font-weight: bold;">总销售额(元): <?php echo $sales; ?></span> &nbsp;&nbsp;<span style="color:green;font-weight: bold;">总佣金(元): <?php echo $profit; ?></span>
...
<script type="text/javascript">
    ...
    $(function(){
        $('.js-help-notes').hover(function(){
            ...
            var html = '<div class="js-intro-popover popover popover-help-notes bottom" style="display: none; top: ' + ($(this).offset().top + 12) + 'px; left: ' + ($(this).offset().left - 20) + 'px;"><div class="arrow"></div><div class="popover-inner"><div class="popover-content"><p><strong>销售额：</strong>分销商出售分销商品的总金额。</p><p><strong>佣金：</strong>分销商出售分销商品获得的利润。</p></div></div></div>';
            $('body').append(html);
