...
<head>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", store_id = "<?php echo $_GET['store_id']; ?>", anthen_url = "<?php dourl('audit_dealer');?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_common.js"></script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_whole_detail.js"></script>
</head>
