...
<html>
	<head>
		...
		<script type="text/javascript">var load_url="<?php dourl('load');?>",drp_checkout_url="<?php dourl('checkout');?>", drp_approve_url="<?php dourl('drp_approve');?>", drp_status_url="<?php dourl('drp_status');?>";</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_seller.js"></script>
        <style type="text/css">
            .popover-inner {
                padding: 1px;
