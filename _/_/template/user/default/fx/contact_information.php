...
<head>
    <meta charset="utf-8"/>
    <title>客服联系方式 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", information_url = "<?php dourl('contact_information'); ?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_common.js"></script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_information.js"></script>
</head>
