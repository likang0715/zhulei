...
<head>
    ...
    <script type="text/javascript">
        var load_url="<?php dourl('load');?>",
            update_margin_minimum="<?php echo dourl('update_margin_minimum');?>",
            margin_amount="<?php dourl('margin_amount');?>",
            update_store_bond="<?php dourl('update_store_bond');?>",
            service_url="<?php dourl('service'); ?>",
            is_required_to_audit="<?php dourl('is_required_to_audit'); ?>",
            is_required_margin="<?php dourl('is_required_margin'); ?>",
            open_store_whole="<?php dourl('open_store_whole');?>",
            setStoreMargin_url="<?php dourl('setStoreMargin');?>";
    </script>

    <script type="text/javascript" src="<?php echo TPL_URL;?>js/fx_whole_setting.js"></script>
</head>
