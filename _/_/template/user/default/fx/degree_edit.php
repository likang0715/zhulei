...
<div class="app__content">
		<form class="js-page-form form-horizontal ui-form" method="POST" novalidate="novalidate">
			<div class="control-group">
				...
				<div class="controls">
					<ul class="hyname">
						...
						?>
								<li>
									<input type="radio" name="degree_id" class="js-degree_id" <?php if($v['is_platform_degree_name']==0 ){?> checked="checked" <?php } ?> data-type="<?php echo $v[''];?>" value="now" id="now" />
									<input type="text"  name="now_degree_name" value="<?php echo $v['name'];?>" style="width:90px;" <?php echo $is_allow_diy_drp_degree ? '' : 'readonly="readonly"'; ?> />
								</li>
							<?php 
							} else {
							?>
								<li>
									<input type="radio" name="degree_id" class="js-degree_id" <?php if($degree_info['is_platform_degree_name'] == $v['pigcms_id']){?> checked="checked" <?php }?> value="<?php echo $v['pigcms_id']?>" id="degree_<?php echo $v['pigcms_id']; ?>" />
									<label for="degree_<?php echo $v['pigcms_id']; ?>" style="display: inline;"><?php echo $v['name']; ?></label>
								</li>
						<?php 
							}
						}
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="level_num" name="level_num" value="<?php echo $degree_info['value']?>" placeholder="请输入数字" style="width:100px;">
	...
	.app-image-list .other_li{background:none;border:0px;}
		...
		<div class="control-group">
						...
						<?php foreach($degree as $k=>$v) {?>
							...
							<?php if($k==='now') {?>
								...
								<li class="other_li sort">
									<div class="spans">
										<span class="checkico <?php if($v['is_platform_degree_icon']==0 ){?> selected-style <?php } else {?>no-selected-style<?php }?>"><i class="icon-ok icon-white"></i>
										<img data-type='now' class="avatar degree_icon_now" id="degree_icon_now" style="max-height:50px;width:auto;height:auto;" src="<?php echo $v['icon']?>">
										</span>
									</div>
								</li>
								<?php }?>
							...
							<li class="other_li sort">
								<div class="spans">
									<span class="checkico <?php if($degree_info['is_platform_degree_icon'] == $v['pigcms_id']){?>selected-style <?php }  else {?>no-selected-style<?php }?>"><i class="icon-ok icon-white"></i>
									<img data-type='<?php echo $v['pigcms_id'];?>' class="avatar" id="degree_icon_<?php echo $v['pigcms_id']; ?>" style="max-height:50px;width:auto;height:auto;" src="<?php echo $v['icon']?>">
									</span>
								</div>
							</li>
							 <?php }?> 
			...
			<div class="control-group">
				...
				<div class="controls">
					<span class="help-inline">积分达到</span> <input type="text" name="points_limit" class="input-mini for-post" value="<?php echo $degree_info['condition_point'];?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input type="text" id="discount" name="seller_reward_1" value="<?php echo $degree_info['seller_reward_1']?>" placeholder="请输入比例" style="width:73px;"><span class="add-on">%</span>
					</div>
					<p class="help-desc">留空为，不提升。</p>
				</div>
			</div>
			...
			<div class="control-group">
				<!--  <label class="control-label">或</label>-->
				<label class="control-label">获取下级<br/>利润提升百分比</label>
				<div class="controls">
					<div class="input-append">
						<input type="text" id="discount" name="seller_reward_2" value="<?php echo $degree_info['seller_reward_2']?>" placeholder="请输入比例" style="width:73px;"><span class="add-on">%</span>
					</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input type="text" id="discount" name="seller_reward_3" value="<?php echo $degree_info['seller_reward_3']?>" placeholder="请输入比例" style="width:73px;"><span class="add-on">%</span>
					</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea id="description" class="description"   style="width:65%" name="description" cols="55" rows="4" placeholder="最多可输入200个字符，简述相关分销等级信息，以便分销商知晓。" maxlength="600"><?php echo $degree_info['description'];?></textarea>
				</div>
			</div>			
			<div class="form-actions">
				<input class="btn btn-primary js-btn-edit-save" type="button" value="保 存" data-loading-text="保 存...">
				<input type="hidden" value="<?php echo $degree_info['pigcms_id']?>" id="degree" >
