				...
				<div class="meal_con_main_con">
					...
					<?php if(!empty($store_physical)){ ?>
							<?php foreach($store_physical as $value){ ?>
								...
								<a href="<?php echo dourl('meal:order'); ?>&physical_id=<?php echo $value['pigcms_id'];?>&action=all"><li>
									<div class="shop_list1">
										<span><img class="meal_con_main_shop_logo" src="<?php echo $array[0];?>" width="80" height="80"></span>
