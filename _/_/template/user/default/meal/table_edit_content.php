...
<head>
	...
	function changePage(page) {
		...
		var url = "<?php echo url('meal:table') ?>&physical_id=<?php echo $_GET['physical_id'];?>";
...
<body class="font14 usercenter hide">
	...
	<div class="wrap_1000 clearfix container">
		...
		<div class="main-content">
			<div class="js-list-filter-region clearfix ui-box" style="position:relative;">
				<div>
					<a href="<?php echo dourl('meal:table_add'); ?>&physical_id=<?php echo $_GET['physical_id'];?>" class="ui-btn ui-btn-primary">新增茶座</a>
				</div>
			</div>
			<!-- 内容头部 -->
						...
						<div class="col-xs-12">
							<div id="shopList" class="grid-view">
								...
								<div class="info" align="center">
									...
									<?php }?>
									<form method="post" enctype="multipart/form-data" action="<?php echo dourl('meal:table_edit'); ?>&physical_id=<?php echo $_GET['physical_id'];?>&cz_id=<?php echo $czn['cz_id'];?>" id="store_form">
