...
<?php if($ok_tips){?>
  ...
  <form method="post" enctype="multipart/form-data" action="<?php echo dourl('meal:cat_edit'); ?>" >
  <input  type="hidden" name="physical_id" value="<?php echo $cat['physical_id'];?>" />
  <input  type="hidden" name="cat_id" value="<?php echo $cat['cat_id'];?>" /
    <table style="width:500px;" align="center">
   	   <tr>
        <th class="paddingT15">分类名称:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="cat_name" type="text" id="cat_name" value="<?php echo $cat['cat_name'];?>"/></td>
      </tr>
	  <tr>
        <th class="paddingT15">分类排序:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="cat_sort" type="text" id="cat_sort" value="<?php echo $cat['cat_sort'];?>"/></td>
      </tr>	
	  <tr>
        <th></th>
