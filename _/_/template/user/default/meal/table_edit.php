...
<head>
 <meta charset="utf-8"/> 
 <title>茶桌管理 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
 ...
 var store_physical_edit_url ='<?php echo dourl('meal:table_edit'); ?>&physical_id=<?php echo $_GET['physical_id'];?>'
 </script>
 <!-- ▲ Constant JS -->
 <!-- ▼ Base JS -->
            ...
            <div class="meal_con_main_con">
              ...
              <form method="post" id="table_form" enctype="multipart/form-data" action="<?php echo dourl('meal:table_edit'); ?>&physical_id=<?php echo $_GET['physical_id'];?>&cz_id=<?php echo $czn['cz_id'];?>" id="store_form">
                ...
                <table class="infoTable" align="center" style="margin-left: 20px;margin-top:20px;">
                  <tr>
                    <td class="table_edit_td"><em class="required">*</em>所属茶馆:</td>
                    <td>
                      <?php echo $now_store['name'];?></td>
                    </tr>
                    <tr>
                      <td class="table_edit_td"><em class="required">*</em>包厢名称:</td>
                      <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="name" maxlength="20" type="text" id="store_name" value="<?php echo $czn['name'];?>" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="paddingT15 wordSpacing5"><select name="wz_id">
                        ...
                        <option value="<?php echo $r['cat_id'];?>" <?php if ($czn['wz_id'] == $r['cat_id']) { ?>selected="true"<?php } ?>><?php echo $r['cat_name'];?></option>
                        <?php } ?>
                        <?php } ?>
                      </select></td>
                    </tr>
                      ...
                      <td class="paddingT15 wordSpacing5">
                        <div class="img-list ui-sortable">
                          <ul class="js-img-list app-image-list clearfix table_edit_img">
                           <div class="preview-img-box"><li class="preview-img"><a href="<?php echo $czn['image'];?>" target="_blank"><img src="<?php echo $czn['image'];?>"></a><a class="js-delete-img close-modal small hide">×</a></li></div>
                           <li>
                            <a href="javascript:;" class="js-add-img">+修改</a>
                          </li>
                        </ul>
                      </div>
                    </td>
                    ...
                    <td class="paddingT15 wordSpacing5">
                      <div class="picture-list ui-sortable">
                        <ul class="js-picture-list app-image-list clearfix table_edit_img">
                         ...
                         <?php foreach($pic_list as $r){ ?>
                         <li class="sort"><a href="<?php echo $r;?>" target="_blank"><img src="<?php echo $r;?>"></a><a class="js-delete-picture close-modal small hide">×</a></li>
                         <?php } ?>
                         <?php } ?>
                         <li>
                ...
                <tr>
                  ...
                  <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="price" type="text" id="price" value="<?php echo $czn['price'];?>" palcehol/> 元/小时</td>
                </tr>
                <tr>
                  <td class="table_edit_td"><em class="required"></em>优惠政策:</td>
                  <td class="paddingT15 wordSpacing5"><textarea name="sale" cols="25" rows="2"><?php echo $czn['sale'];?></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="paddingT15 wordSpacing5"><label style="float: left;margin-right: 20px;"><input type="radio" <?php if ($czn['status'] == 1) { ?>checked="true"<?php } ?> value="1" name="status">&nbsp;可预约</label><label  style="float: left;margin-right: 20px;"><input type="radio" <?php if ($czn['status'] == 2) { ?>checked="true"<?php } ?> value="2" name="status">&nbsp;不可预约</label></td>
                </tr>
                <tr>
                  <td class="paddingT15 wordSpacing5" colspan="2">
                   <script id="editor_add" name="content" type="text/plain"><?php echo $czn['content'];?></script>
                 </td>
               </tr>
               <tr>
