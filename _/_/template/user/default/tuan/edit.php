				...
				<div class="presale-info">
					<div class="js-basic-info-region">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name" value="<?php echo htmlspecialchars($tuan['name']) ?>" id="name" placeholder="请填写活动名称" style="width: 300px;" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<ul class="ico app-image-list js-product" data-product_id="<?php echo $product['product_id'] ?>">
									<?php 
									if (!empty($product)) {
									?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="start_time" value="<?php echo date('Y-m-d H:i:s', $tuan['start_time']) ?>" class="js-start-time Wdate" id="js-start-time" readonly style="cursor:default; background-color:white" />
							<span>至 </span>
							<input type="text" name="end_time" value="<?php echo date('Y-m-d H:i:s', $tuan['end_time']) ?>" class="js-end-time Wdate" id="js-end-time" readonly style="cursor:default; background-color:white" />
						</div>
					</div>
					<div class="control-group">
						...
						<div class="reward-table-wrap">
							<table class="reward-table js-condition-table">
								...
								<?php 
								if (is_array($tuan_config_list)) {
									foreach ($tuan_config_list as $tuan_config) {
								?>
										<tr class="js-condition js-condition-detail" style="text-align: center;" data-item_id="<?php echo $tuan_config['id'] ?>">
											<td><?php echo $tuan_config['number'] ?></td>
											<td><?php echo $tuan_config['discount'] ?></td>
											<!-- <td><?php echo $tuan_config['start_number'] ?></td> -->
											<td>
												<?php 
												if ($tuan_config['number'] == 1) {
												?>
													-
												<?php 
												} else {
												?>
													<a href="javascript:" class="js-condition-delete">删除</a>
												<?php 
												}
												?>
											</td>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea rows="5" cols="55" style="width:65%" name="description" id="description" class="shuoming"><?php echo htmlspecialchars($tuan['description']) ?></textarea>
							<em class="error-message"></em>
						</div>
					</div>
				</div>
			...
			<div class="app-design">
				<div class="app-actions">
					<div class="form-actions text-center">
						<input type="hidden" id="tuan_id" value="<?php echo $tuan['id'] ?>" />
