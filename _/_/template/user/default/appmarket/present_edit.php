						...
						<div class="control-group edit-group">
							...
							<!-- 仅编辑状态下才展示 -->
								...
								<div class="current-present clearfix" data-product_id="<?php echo $product['product_id'] ?>">
									<a href="<?php echo option('config.wap_site_url') . '/good.php?id=' . $product['product_id'] ?>" target="_blank" class="current-present-img">
									...
									<div class="current-present-tips">
										<a href="<?php echo option('config.wap_site_url') . '/good.php?id=' . $product['product_id'] ?>" target="_blank"><?php echo htmlspecialchars($present['name']) ?></a>
