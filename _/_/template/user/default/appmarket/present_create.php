				...
				<div class="present-info">
					<div class="js-basic-info-region">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name" id="name" value="" placeholder="请填写活动名称" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">
							...
							<div class="controls">
								<input type="text" name="start_time" value="" class="js-start-time Wdate" id="js-start-time" readonly="readonly" id="" style="cursor:default; background-color:white" />
								<span>至</span>
								<input type="text" name="end_time" value="" class="js-end-time Wdate" id="js-end-time" readonly="readonly" id="" style="cursor:default; background-color:white" />
							</div>
						</div>
						<!-- <div class="control-group">
							<label class="control-label">
							...
							<div class="controls">
								<input type="text" name="expire_date" id="expire_date" class="js-start-percent w30" value="" />
								<span>天</span>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="expire_number" id="expire_number" class="js-start-percent w30" value="" />
								<span>次/人</span>
							</div>
						...
						<div class="control-group edit-group">
							...
							<!-- 仅编辑状态下才展示 -->
								<!-- <div class="current-present clearfix">
									<a href="#" class="current-present-img">
