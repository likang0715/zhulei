				...
				<tr class="widget-list-item">
					...
					<td class="goods-image-td text-center">
						<div class="goods-image js-goods-image">
							<a href="<?php echo option('config.wap_site_url') . '/good.php?id=' . $product['product_id']; ?>" target="_blank" class="current-present-img"><img src="<?php echo $product['image'] ?>" style="max-height:80px; max-width:80px;" /></a>
						</div>
					</td>
					<td class="goods-meta">
						<p class="goods-title">
							<a href="<?php echo option('config.wap_site_url') . '/good.php?id=' . $product['product_id']; ?>" target="_blank" class="new-window" title="<?php echo htmlspecialchars($product['name'])?>">
