...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>预售管理 - <?php echo $store_session['name']; ?> | <?php echo $config['site_name'];?></title>
		...
		<script type="text/javascript">
			...
			var page_content = "presale_index";
			var page_product_list = "product_list";
			var page_presale_create = "presale_create";
			var page_presale_edit = "presale_edit";
			var disabled_url = "<?php dourl('presale_disabled') ?>";
			var delete_url = "<?php dourl('presale_delete') ?>";
			var presale_wap_url = "<?php echo option('config.wap_site_url') ?>/presale.php";
			var presale_ewm_url = "<?php echo option("config.site_url");?>/source/qrcode.php?type=presale";
		</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/presale.js"></script>
		<style>
		.js-default-reward-condition select,.js-reward-coupon{width:125px;font-size:11px;}
		</style>
	</head>
