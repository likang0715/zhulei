...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>小尾巴 - <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
            ...
            <div id="container-left">
				...
				<div class="app-inner clearfix">
					<div class="app-init-container">
						<div id="kdt_messages_autoreply" class="app__content content clearfix">
