...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>微信菜单 - <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
        <meta name="copyright" content="<?php echo $config['site_url'];?>"/>
		<script type="text/javascript" src="<?php echo STATIC_URL;?>js/jquery.min.js"></script>
		<script type="text/javascript" src="<?php echo STATIC_URL;?>js/jquery.sortable.js"></script>
		...
		<script type="text/javascript" charset="utf-8" src="<?php echo STATIC_URL;?>js/ueditor/ueditor.all.min.js"></script>
														...
														<div class="select-link js-select-link " data-id="<?php echo $data_id;?>">
															...
															<div class="opts dropdown hover">
																...
																<ul class="dropdown-menu">
																	...
																	<li>
																		<a class="js-modal-generalize" data-type="generalize" data-alias="推广二维码" data-title="" data-url="" href="javascript:void(0);">获取推广二维码</a>
																	</li>
																	<li>
