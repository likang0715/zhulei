...
<!--div class="widget-app-board-control">
	<label class="js-switch ui-switch pull-right ui-switch-on"></label>
</div-->
</div>
...
<div class="field-wrap clearfix js-field-wrap">
	...
	<div class="menu-main">
		<div class="menu-content" style="min-height:<?php echo 80 + 38 * count($lm['list']);?>px">
			<div class="link-to js-link-to  <?php if(isset($lm['list']) && $lm['list']) echo 'hide';?>" data-id="<?php echo $lm['id'];?>" id="content_<?php echo $lm['id'];?>">
