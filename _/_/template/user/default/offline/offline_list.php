...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>手工做单列表 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/offline_list.js"></script>
		<script>
		var order_offline_complete_url = "<?php echo url('offline:complete') ?>";
		</script>
	</head>
