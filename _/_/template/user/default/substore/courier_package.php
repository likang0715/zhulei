...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>配送员包裹 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
        ...
        <script type="text/javascript" src="<?php echo TPL_URL;?>js/substore_courier_package.js"></script>
	</head>
