...
<html>
	<head>
		...
		<script type="text/javascript">var load_url="<?php dourl('trade:delivery_load');?>",add_url="<?php dourl('trade:delivery_modify');?>",delete_url="<?php dourl('trade:delivery_delete');?>",copy_url="<?php dourl('trade:delivery_copy');?>",edit_url="<?php dourl('trade:delivery_amend');?>";</script>
