...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>所有订单 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">
			...
			order_checkout_url="<?php dourl('order:order_checkout_csv');?>"
			order_download_url="<?php dourl('order:order_download_csv');?>";</script>
