        ...
        <table class="ui-table ui-table-list" style="padding: 0px;">
            <thead class="js-list-header-region tableFloatingHeaderOriginal">
                <tr class="widget-list-header">
                    ...
                    <th class="cell-12 text-right">服务费</th>
                    <th class="cell-12 text-right">实际提现金额(元)</th>
                    <th class="cell-15">处理完成时间</th>
                    <th class="cell-15" style="width: 50px;">状态</th>
            ...
            <tbody class="js-list-body-region">
                ...
                <tr class="widget-list-item">
                    ...
                    <td width="195">
                        <?php if (!empty($withdrawal['bank_id'])) { ?>
                        <?php if ($withdrawal['withdrawal_type']) { ?>公司账户<?php } else { ?>个人账户<?php } ?> |
                    ...
                    <td class="text-right"><?php echo $withdrawal['sales_ratio']; ?>%</td>
                    <td class="text-right ui-money-income"><?php echo $withdrawal['real_amount']; ?></td>
                    ...
                    <td>
                        ...
                        <?php if (empty($withdrawal['bak'])) { ?>
                        提现失败，该笔资金已返还到您的账号余额中
                        <?php } else { ?>
                        <?php echo $withdrawal['bak']; ?>
                        <?php } ?>
                        ...
                        <?php } else { ?>
                            <?php echo $withdrawal['bak']; ?>
                        <?php } ?>
                        <?php } else if (!empty($withdrawal['bak'])) { ?>
                            <?php echo $withdrawal['bak']; ?>
                        <?php } ?>
                    </td>
                </tr>
