...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>店铺<?php echo $point_alias; ?>兑换 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">var load_url="<?php dourl('delivery_load');?>",exchange_url="<?php dourl('point_exchange');?>", point_alias = "<?php echo $point_alias; ?>";</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/point_exchange.js"></script>
	</head>
