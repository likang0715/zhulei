        ...
        <table class="ui-table ui-table-list" style="padding: 0px;">
            <thead class="js-list-header-region tableFloatingHeaderOriginal">
                <tr class="widget-list-header">
                    ...
                    <th class="cell-10 text-right">利润(元)</th>
                    <th class="cell-10 text-right">累计收益(元)</th>
            ...
            <tbody class="js-list-body-region">
                ...
                <tr class="widget-list-item">
                    ...
                    <td class="text-right"><?php if ($record['income'] > 0) { ?><?php echo $record['real_profit']; ?><?php } ?></td>
                    <td class="text-right"><?php if ($record['income'] > 0) { ?><?php echo $record['balance']; ?><?php } else { ?>0.00<?php } ?></td>
                    <td>
