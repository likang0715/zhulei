<div><div class="page-settlement">
        <div class="ui-box settingWithdrawal-region">
            <div class="header">设置提现账号<?php if(!$is_change_bankcard_open){ ?><span style="color: red;">（若要修改信息,请联系平台运营方）</span><?php } ?></div>
                ...
                <fieldset>
                    <div class="form-top-info">
                        ...
                        <div class="control-group type-wrap">
                            ...
                            <div class="controls">
                                <div class="type-item">
                                    <input class="js-chose" id="type0" type="radio" value="0" name="type" <?php if ($withdrawal_type == 0) { ?>checked="true"<?php } ?> />
                                    <label for="type0">
                                ...
                                <div class="type-item">
                                    <input class="js-chose" id="type1" type="radio" value="1" name="type" <?php if ($withdrawal_type == 1) { ?>checked="true"<?php } ?> />
                                    <label for="type1">
                    ...
                    <div class="type-content">
                        <div class="js-type-0 js-type">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls bank-map js-bank-map-region">
                                    <select class="bank" name="bank">
                                        ...
                                        <option value="<?php echo $bank['bank_id']; ?>" <?php if ($bank['bank_id'] == $bank_id) { ?>selected="true"<?php } ?>><?php echo $bank['name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <div class="widget-account-pretty">
                                        <div class="widget-account-pretty-input">
                                            <input type="text" placeholder="只支持提现至借记卡，不支持信用卡和存折；" name="bank_card" class="js_bank_card" value="<?php echo $bank_card; ?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" placeholder="准确填写银行卡开卡人姓名，否则无法提现；" name="bank_card_user" class="js_bank_card_user" value="<?php echo $bank_card_user; ?>" />
                                </div>
                            </div>
                            <!--<div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <input type='hidden' name='is_dividends' class='is_dividends' value=<?php echo $is_dividends; ?> >
                                ...
                                <?php } ?>
                                <button class="btn btn-cancel js-cancel-btn" type="button">返回</button>
                            </div>
                        </div>
                    </div>
                </fieldset>
