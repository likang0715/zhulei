...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>保证金流水 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">var load_url="<?php dourl('delivery_load');?>",pay_url="<?php dourl('margin_recharge');?>", pay_qrcode_url="<?php dourl('margin_recharge_qrcode');?>", type = "<?php echo $type; ?>";</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/margin_details.js"></script>
	</head>
