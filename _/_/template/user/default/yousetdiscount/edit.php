...
<nav class="ui-nav clearfix" style="width:auto;">
	<ul class="pull-left">
		<li id="js-list-nav-all" class="active">
			<a href="javascript:void(0)">修改【<?php echo $yousetdiscount['name']; ?>】活动</a>
		</li>
	</ul>
</nav>
	...
	<div class="page-presale clearfix">
		<div class="app-presale app-reward">
			<form class="form-horizontal" id="myformaaaaaaa">
				<input type="hidden" id="yid" name="id" value="<?php echo $yousetdiscount['id'] ?>">
				<div class="module-goods-list">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="name" value="<?php echo $yousetdiscount['name'] ?>" id="name" placeholder="请填写名称" style="width: 600px;" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="startdate" name="startdate" value="<?php echo date('Y-m-d H:i:s', $yousetdiscount['startdate']) ?>">
							 &nbsp; &nbsp; 
							<input type="text" id="enddate" name="enddate" value="<?php echo date('Y-m-d H:i:s', $yousetdiscount['enddate']) ?>">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls js-pictures">
							<input type="hidden" id="fxpic" name="fxpic" value="<?php echo $yousetdiscount['fxpic'] ?>">
							<ul class="ico app-image-list">
								<li class="sort">
									<a href="<?php echo $yousetdiscount['fxpic'] ?>" target="_blank"><img src="<?php echo $yousetdiscount['fxpic'] ?>"></a>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="fxtitle" name="fxtitle" value="<?php echo $yousetdiscount['fxtitle'] ?>" style="width:600px;" />
						</div>
						<span class="controls-tip">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="fxinfo" name="fxinfo" value="<?php echo $yousetdiscount['fxinfo'] ?>" style="width:600px;" />
						</div>
						<span class="controls-tip">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="fxtitle2" name="fxtitle2" value="<?php echo $yousetdiscount['fxtitle2'] ?>" style="width:600px;" />
						</div>
						<span class="controls-tip">
							不填则默认为：我在{{时间}}秒内获得了{{分值}}的分值，手都快抽筋，你也来试试看！<br>
							填写时可带参数{{时间}}和{{分值}}<br>
							例如：我在{{时间}}秒内获得了{{分值}}的分值，手都快抽筋，你也来试试看！<br>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="fxinfo2" name="fxinfo2" value="<?php echo $yousetdiscount['fxinfo2'] ?>" style="width:600px;" />
						</div>
						<span class="controls-tip">
							分享给一个朋友时标题下显示的描述，或者分享到朋友圈时显示的描述，不填则默认为活动名称，使用方法同上。
						</span>
					...
					<div class="control-group">
						...
						<div class="controls js-pictures">
							<input type="hidden" id="bg1" name="bg1" value="<?php echo $yousetdiscount['bg1'] ?>">
							<ul class="ico app-image-list">
								<li class="sort">
									<a href="<?php echo $yousetdiscount['bg1'] ?>" target="_blank"><img src="<?php echo $yousetdiscount['bg1'] ?>"></a>
									<a class="js-delete-picture close-modal small hide">×</a>
								</li>
								<li class="hide"><a href="javascript:;" class="add-pic ">选图片</a></li>
							</ul>
					...
					<div class="control-group">
						...
						<div class="controls js-pictures">
							<input type="hidden" id="bg2" name="bg2" value="<?php echo $yousetdiscount['bg2'] ?>">
							<ul class="ico app-image-list">
								<li class="sort">
									<a href="<?php echo $yousetdiscount['bg2'] ?>" target="_blank"><img src="<?php echo $yousetdiscount['bg2'] ?>"></a>
									<a class="js-delete-picture close-modal small hide">×</a>
								</li>
								<li class="hide"><a href="javascript:;" class="add-pic">选图片</a></li>
							</ul>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="my_count" name="my_count" value="<?php echo $yousetdiscount['my_count'] ?>" style="width:80px;" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<input type="text" id="friends_count" name="friends_count" value="<?php echo $yousetdiscount['friends_count'] ?>" style="width:80px;" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<input type="text" id="playtime" name="playtime" value="<?php echo $yousetdiscount['playtime'] ?>" style="width:80px;" /> (秒)
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<input type="text" id="money_end" name="money_end" value="<?php echo $yousetdiscount['money_end'] ?>" style="width:80px;" />
						</div>
						<span class="controls-tip">
					...
					<div class="control-group">
						...
						<div class="controls direction_box">
							...
							<?php $level = ($key + 1); ?>
							<div class="direction_li" data-level="<?php echo $level ?>">
								<div class="dir_left">兑换档次(<?php echo $level ?>)：满 <input type="text" name="at_least[]" value="<?php echo $val['at_least'] ?>" style="width: 60px;" readonly> 分，可兑换优惠劵 </div>
								<div class="dir_right">
									<span title="价值<?php echo $val['face_money'] ?>元" class="js-coupon">价值<?php echo $val['face_money'] ?>元劵<?php echo '['.$val['number'].'/'.$val['total_amount'].']'; ?></span>
									<!-- <a href="javascript:void(0)" class="js-add-coupon">选优惠劵</a> -->
								</div>
								<input type="hidden" name="coupon_ids[]" value="<?php echo $val['coupon_id'] ?>">
							</div>
							<?php } ?>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
						<script id="info" name="info" type="text/plain" value="<?php echo $yousetdiscount['info'] ?>"></script>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label style="display: inline-block;margin-right: 20px;margin-top: 5px;"><input type="radio" name="is_attention" value="0" <?php if ($yousetdiscount['is_attention'] == 0) echo 'checked'; ?> style="margin:0 2px 0 0" /> 否</label>
							<label style="display: inline-block;margin-right: 20px;margin-top: 5px;"><input type="radio" name="is_attention" value="1" <?php if ($yousetdiscount['is_attention'] == 1) echo 'checked'; ?> style="margin:0 2px 0 0" /> 是</label>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label style="display: inline-block;margin-right: 20px;margin-top: 5px;"><input type="radio" name="is_open" value="0" <?php if ($yousetdiscount['is_open'] == 0) echo 'checked'; ?> style="margin:0 2px 0 0" />开 启</label>
							<label style="display: inline-block;margin-right: 20px;margin-top: 5px;"><input type="radio" name="is_open" value="1" <?php if ($yousetdiscount['is_open'] == 1) echo 'checked'; ?> style="margin:0 2px 0 0" />关 闭</label>
						</div>
					</div>
				</div>
			</form>

			<?php if ($yousetdiscount['is_open'] == 1) { ?>
...
<script type="text/javascript">
	$(function(){
		...
		ueditor.addListener("ready", function(){
	        ueditor.setContent("<?php echo $yousetdiscount['info']; ?>");
		});
