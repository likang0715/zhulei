...
<html>
	<head>
		...
		<script type="text/javascript">var load_url="<?php dourl('load');?>", product_id = "<?php echo $_GET['id']; ?>", fx_url="<?php echo dourl('goods_fx_setting', array('role' => $_GET['role'])); ?>";</script>
