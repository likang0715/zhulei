...
<div class="goods-list">
    <div class="js-list-filter-region clearfix ui-box" style="position: relative;">
        <div>
            <h3 class="list-title js-goods-list-title">评价店铺列表</h3>
    ...
    <div class="ui-box">
        <table class="ui-table ui-table-list" style="padding: 0px;">
            ...
            <tr>
                ...
                <th class="checkbox cell-35" colspan="<?php echo option('config.is_allow_comment_control') == 1 ? 3 :2 ?>" style="min-width: 200px; max-width: 200px;">
                ...
                <tr>
					...
					<td class="">
						...
						<a <?php if(option('config.is_allow_comment_control') == 1) { ?>class="js-change-num"<?php }?> href="javascript:void(0);">                 
							...
							<select data="<?php echo $comment['id']; ?>" name="" class="js-input-num js-type-select" style="width:100px;height:26px;display:none" data-type="store">
                                <option value="1" <?php if ($comment['status'] == 1) { echo 'selected=selected'; } ?> >通过审核</option>
                                <option value="2" <?php if ($comment['status'] == 0) { echo 'selected=selected'; } ?> >未通过审核</option>
							 </select>
							<?php }?><br/>
							
							<?php if(option('config.ischeck_to_show_by_comment') == 1) { ?>
									需审核显示
							<?php }else{?>
									无需审核显示
							<?php }?>
                    ...
                    <td class="text-right">
                       <?php if(option('config.is_allow_comment_control') == 1) { ?>
					   <p>
                            <a href="javascript:void(0);" class="js-delete" data="<?php echo $comment['id']; ?>" data-type="store">删除</a><span></span>
                       </p>
					   <?php }else{?>
							不予删除
					   <?php }?>
    ...
    <div class="js-list-footer-region ui-box">
        ...
        <div>
        	...
        	?>
	            <div class="pull-left">
	                <a href="javascript:;" class="ui-btn js-batch-delete" data-type="store">删除</a>
	            </div>
            <?php 
        	}
            ?>
