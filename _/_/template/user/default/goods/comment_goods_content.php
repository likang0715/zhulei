...
<div class="goods-list">
                ...
                <tr>
					...
					<td class="">
						<a <?php if(option('config.is_allow_comment_control') == 1) { ?>class="js-change-num"<?php }?> href="javascript:void(0);">                 
							...
							<select data="<?php echo $comment['id']; ?>" name="" class="js-input-num js-type-select" style="width:100px;height:26px;display:none" data-type="goods">
                    ...
                    <td class="text-right">
                     <?php if(option('config.is_allow_comment_control') == 1) { ?>
					   <p>
                            <a href="javascript:void(0);" class="js-delete" data="<?php echo $comment['id']; ?>" data-type="goods">删除</a><span></span>
                       </p>
					   <?php }else{?>
							不予删除
					   <?php }?>
    ...
    <div class="js-list-footer-region ui-box">
        ...
        <div>
        	...
        	?>
	            <div class="pull-left">
	                <a href="javascript:;" class="ui-btn js-batch-delete" data-type="goods">删除</a>
	            </div>
            <?php 
        	}
            ?>
