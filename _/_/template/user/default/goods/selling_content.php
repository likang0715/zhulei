                ...
                <!-- <div class="js-list-tag-filter ui-chosen" style="right:210px;">
        			<span>
        				<select id="select_level">
        					<option value="selling">导出当前类别商品</option>
                    ...
                    <td class="text-right">
                        <p>
                         ...
                         <?php if(in_array(PackageConfig::getRbacId(7,'goods','promotion'), $rbac_result) || $package_id == 0){?>
                            <span>-</span>
                            <a href="javascript:void(0);" class="js-promotion-btn" <?php if (!empty($product['supplier_id'])) { ?>data-fx="true"<?php } else { ?>data-fx="false"<?php } ?> data="<?php echo $product['product_id']; ?>" data-store-id="<?php echo $_SESSION['store']['store_id']; ?>">推广商品</a>
