...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>专题分类 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">
			...
			var location_type = "subject_diy";
			var page_content = "subject_diy_content";

			var subtype_create_url = "<?php echo dourl('subtype_create')?>";
			var subtype_edit_url = "<?php echo dourl('subtype_edit')?>";
			var subtype_delete_url = "<?php dourl('subtype_delete');?>";
			var subtype_disabled_url = "<?php dourl('subtype_disabled')?>";
			var subtype_able_url = "<?php dourl('subtype_able')?>";
			var subtype_addsave_url = "<?php echo dourl('subtype_create');?>";
			var subtype_px_url = "<?php echo dourl('subtype_px');?>";
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/subject_diy.js"></script>
	</head>
