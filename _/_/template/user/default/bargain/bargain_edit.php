<form class="form" method="post" enctype="multipart/form-data">
    <div class="content">
        <div class="cLineB"><h4 class="left">添加一个砍价商品</h4><a href="<?php dourl('bargain:index');?>" class="right btnGreen">返回</a></div>
        <div class="msgWrap bgfc">
            <table class="userinfoArea" style="margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <input type="hidden" id="keyword" value="关键词" name="keyword" style="width:400px"/>
                <tr valign="top">
        ...
        <div class="msgWrap bgfc">
            <table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="number"  id="original" value="<?php echo $bargain['original']/100;?>" name="original" style="width:100px"/>&nbsp;原价不能低于底价，单位（元）
                        <span class="new">（注：支持小数，精确到小数点后两位）</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="red">*</span>商品底价：</th>
                    <td><input type="number"  id="minimum" value="<?php echo $bargain['minimum']/100;?>" name="minimum" style="width:100px"/>&nbsp;底价不能高于原价，单位（元）
                        <span class="new">（注：支持小数，精确到小数点后两位）</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="red">*</span>每次砍价范围</th>
                    <td><input type="number"  id="kan_min" name="kan_min" style="width:100px" value="<?php echo $bargain['kan_min']/100;?>">
                        &nbsp;到&nbsp;
                        <input type="text"  id="kan_max" name="kan_max" style="width:100px" value="<?php echo $bargain['kan_max']/100;?>">
                        &nbsp;（单位：元）（注：自己或朋友砍下一刀的范围，砍价范围里的最大值不能大于商品原价减去底价，若砍下后小于底价则砍至底价,精确到小数点后两位）
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="msgWrap bgfc">
            <table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <tr class="new">
                    ...
                    <td><input type="number"  id="rank_num" name="rank_num" style="width:100px" value="<?php echo $bargain['rank_num'];?>">
                        &nbsp;不填默认为10
                    </td>
                </tr>
                <tr style="display:none;">
                    <td>
                        ...
                        <input type="hidden" id="sku_id" name="sku_id" value="<?php echo $bargain['sku_id'];?>"/>
                        <input type="hidden" id="product_id" name="product_id" value="<?php echo $bargain['product_id'];?>"/>
                        <input type="number" id="inventory" value="<?php echo $bargain['inventory'];?>" name="inventory"/>
                        <input type="input" id="logoimg1" name="logoimg1" value="<?php echo $bargain['logoimg1'];?>"/>
                        <input type="input" id="logoimg2" name="logoimg2" value="<?php echo $bargain['logoimg2'];?>"/>
                        <input type="input" id="logoimg3" name="logoimg3" value="<?php echo $bargain['logoimg3'];?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        　<a href="<?php dourl('bargain:index');?>" class="btnGray vm">取消</a>
                    </td>
                </tr>
                </tbody>
            </table>
