        ...
        <div class="msgWrap bgfc">
            <table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="number"  id="original" value="" name="original" style="width:100px"/>&nbsp;原价不能低于底价，单位（元）
                        <span class="new">（注：支持小数，精确到小数点后两位）</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="red">*</span>商品底价：</th>
                    <td><input type="number"  id="minimum" value="" name="minimum" style="width:100px"/>&nbsp;底价不能高于原价，单位（元）
                        <span class="new">（注：支持小数，精确到小数点后两位）</span></td>
                </tr>
                <tr>
                    <th valign="top"><span class="red">*</span>每次砍价范围</th>
                    <td><input type="number"  id="kan_min" name="kan_min" style="width:100px">
                        &nbsp;到&nbsp;
        ...
        <div class="msgWrap bgfc">
            <table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <tr class="new">
                    ...
                    <td><input type="number"  id="rank_num" name="rank_num" style="width:100px">
                        &nbsp;不填默认为10
                    </td>
                </tr>
                <tr style="display:none;">
                    <td>
                        ...
                        <input type="hidden" id="logoimg1" name="logoimg1" value=""/>
                        <input type="hidden" id="logoimg2" name="logoimg2" value=""/>
                        <input type="hidden" id="logoimg3" name="logoimg3" value=""/>
                    </td>
                </tr>
                <tr>
