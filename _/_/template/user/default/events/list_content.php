		...
		<ul>
			...
			<li>
				...
				<div class="events_list_des">
					<span class="events_date"><?php echo date('Y-m-d',strtotime($value['sttime']));?>至<?php echo date('m-d',strtotime($value['endtime']));?></span>
				...
				<div class="events_list_op">
					<label>
						...
						<a href="<?php dourl('events:baoming');?>&id=<?php echo $value['pigcms_id'];?>"><span class="events_results hint--top hint--top4 hint--no-animate" data-hint="报名情况" data-num="<?php echo $value['pigcms_id'];?>"></span></a>
					</label>
				</div>
			</li>
			<?php } ?>
