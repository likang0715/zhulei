...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var location_type = "tag";
			var page_create = "tag_create";
			var page_edit = "tag_edit";
			var page_list_url = "<?php echo url("tag")?>";
			var delete_url = "<?php dourl('delete',array('type'=>'tag')) ?>";
			var page_content = "tag_content";
			var page_downloadcsv = "<?php dourl('load',array('page'=>'tag_download_by_csv')) ?>";
			var degree_exchange_type_url = "<?php dourl('degree_exchange_type');?>";
        ...
        <!-- ▲ Base JS -->
        <!-- ▼ Member JS -->
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/kehu.js"></script>
        <!-- ▲ Member JS -->
	</head>
