...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>会员管理 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<link href="<?php echo STATIC_URL;?>css/jquery.ui.css" type="text/css" />
        <!-- ▲ Base CSS -->
        <!-- ▼ Member CSS -->
        ...
        <!-- ▲ Base JS -->
        <!-- ▼ Member JS -->
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/member_manage.js"></script>
        <!-- ▲ Member JS -->
		<style>
