        ...
        <div class="app-entry">
            <div class="app-config js-config-region">
                <div class="app-field clearfix editing">
					...
					<div class="control-group">
						<div class="custom-richtext"></div>
					</div>
					<div class="control-group">
						<ul class="custom-nav custom-nav-noicon clearfix">
							<li>
								<a class="clearfix" href="javascript:;" target="_blank">
									<span class="custom-nav-title">第0条微页面标题</span>
									<i class="right right-arrow"></i>
								</a>
							</li>							
							<li>
								<a class="clearfix" href="javascript:;" target="_blank">
									<span class="custom-nav-title">第1条微页面标题</span>
									<i class="right right-arrow"></i>
								</a>
							</li>							
							<li>
								<a class="clearfix" href="javascript:;" target="_blank">
									<span class="custom-nav-title">第N条微页面标题</span>
									<i class="right right-arrow"></i>
								</a>
							</li>						
						</ul>
...
<div style="display:none;" id="edit_data" cat-name="<?php echo $now_category['cat_name'];?>" moban="<?php echo $now_category['moban'];?>" cat-src="<?php echo $now_category['cover_img'];?>" cat-id="<?php echo $now_category['cat_id'];?>" first-sort="<?php echo $now_category['first_sort'];?>" second-sort="<?php echo $now_category['second_sort'];?>"><?php echo $now_category['cat_desc'];?></div>
