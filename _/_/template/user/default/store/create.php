									...
									<div>
										<form class="form-horizontal" action="<?php dourl('create'); ?>" method="post">
											<fieldset>
												...
												<div class="control-group">
													<label class="control-label"><?php if (!$has_company){ ?>公司<?php } else {?>店铺<?php }?>联系地址：</label>
													<div class="controls">
														<span>
												...
												<div class="control-group">
													<label class="control-label">经营人手机号：</label>
													<div class="controls">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="legal_person" placeholder="请填写真实姓名" value="" class="legal-person"/>
													</div>
												</div>
												<div class="control-group">
												...
												<div class="controls">
													<input type="hidden" name="next_type" value="template" />
													<?php 
													if ($diy_attestation_count) {
													?>
														<button class="btn btn-large btn-primary submit-btn" type="button" disabled="" data-type="attestation">立即认证</button>
													<?php 
													}
													?>
													<button class="btn btn-large btn-primary submit-btn" type="button" disabled="" data-type="template"><?php if (!$has_company){ ?>创建公司和店铺<?php }else{ ?>创建店铺<?php } ?></button>
												</div>
											</fieldset>
										</form>
									</div>
