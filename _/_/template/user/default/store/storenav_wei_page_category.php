<div class="modal-header">
    ...
    <ul class="module-nav modal-tab">
        <li class=""><a href="#js-module-feature" data-type="feature" class="js-modal-tab">微页面</a> |</li>
        <li class="active"><a href="#js-module-category" data-type="category" class="js-modal-tab">微页面分类</a> |</li>
        <li class="link-group link-group-1"><a href="<?php dourl('wei_page_category'); ?>" target="_blank" class="new_window">分类管理</a></li>
    </ul>
</div>
<div class="modal-body">
<div class="tab-content">
    <div id="js-module-category" class="tab-pane module-category active">
    <table class="table">
        ...
        <tr>
            ...
            <td class="opts">
                <div class="td-cont">
                    <button class="btn js-choose" href="<?php echo $config['wap_site_url'];?>/pagecat.php?id=<?php echo $wei_page_category['cat_id'];?>" data-id="<?php echo $wei_page_category['cat_id']; ?>" data-url="#" data-page-type="category" data-cover-attachment-id="" data-cover-attachment-url="" data-title="<?php echo $wei_page_category['cat_name']; ?>" data-alias="<?php echo $wei_page_category['cat_id']; ?>">选取
                    </button></div>
            </td>
