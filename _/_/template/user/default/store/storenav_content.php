                ...
                <form class="form-horizontal edit-shopnav" novalidate="">
                    <div class="edit-shopnav-on-page">
                        ...
                        <div>
							...
							<label class="checkbox inline"><input type="checkbox" name="use_nav_page" value="6" <?php if (in_array(6, $use_nav_pages)) { ?>checked="true"<?php } ?> />专题分类展示</label>
							<!-- <label class="checkbox inline"><input type="checkbox" name="use_nav_page" value="7" <?php if (in_array(7, $use_nav_pages)) { ?>checked="true"<?php } ?> />团购主页</label> -->
							<!-- <label class="checkbox inline"><input type="checkbox" name="use_nav_page" value="8" <?php if (in_array(8, $use_nav_pages)) { ?>checked="true"<?php } ?> />一元夺宝主页</label> -->
                        </div>
                    </div>
                                                ...
                                                <div class=" clearfix">
                                                    ...
                                                    <div class="dropdown hover pull-right">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="js-modal-subject_type" data-type="subject_type" href="javascript:;">专题分类展示</a></li>
                                                            <li style="display:none"><a class="js-modal-tuan" data-type="tuan" href="javascript:;">团购主页</a></li>
                                                            <li style="display:none"><a class="js-modal-yydb" data-type="yydb" href="javascript:;">一元夺宝主页</a></li>
