        ...
        <div class="balance">
            <div class="balance-info" style="position:relative">
                ...
                <div class="balance-content">
                    ...
                    <span>&nbsp;&nbsp;&nbsp;<a href="<?php dourl('trade:income'); ?>#inoutdetail">查看明细</a></span>
                </div>
                <div class="wait-profit">
                    待支出分润：<span class="red"><?php echo $seller_unbalance; ?></span> 元
                </div>
            </div>

            <div class="balance-info" style="border-left: none; position:relative">
                <div class="balance-title">可提现金额<div class="help"></div></div>
                <div class="balance-content">
                ...
                <div class="wait-profit">
                    待支出分润：<span class="red"><?php echo $seller_balance; ?></span> 元
                </div>
            </div>
