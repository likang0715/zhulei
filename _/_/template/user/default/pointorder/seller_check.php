...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>分销商对账详情 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">
			...
			var page_content = "seller_check_content";
		</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/seller_check.js"></script>
