    ...
    <table class="ui-table-order">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    <?php echo $order['order_no']; ?> <?php if ($order['type'] == 5) { ?><span class="platform-tag" style="background-color:#07d">批发</span><?php } else if ($order['type'] == 3) { ?><span class="platform-tag">分销</span><?php } ?>
                    <div class="clearfix">
