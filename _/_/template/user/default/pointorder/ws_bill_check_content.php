        ...
        <?php } else { ?>
            ...
            <table class="ui-table-order">
                ...
                <span class="block-help">
					<a href="javascript:void(0);" class="js-help-notes"></a>
					<div class="js-notes-cont hide">
                        <p><strong>对账金额：</strong>每笔订单经销商应给供货商的商品成本价.</p>
                    </div>
				</span>
                    </th>
                    ...
                    <?php foreach ($order['products'] as $key => $product) { ?>
                        <tr class="content-row">
                            ...
                            <td class="price-cell">
                                ...
                                <p>(<?php echo $product['quantity']; ?>件)</p>
                            </td>
                                ...
                                <td class="pay-price-cell" rowspan="<?php echo count($order['products']); ?>">
                                    <div class="td-cont">
                                        <p class="js-order-state">
                                            <span class="order-total"><?php echo $order['cost_total']; ?></span>
                                        </p>
                                    </div>
                                </td>
                                    ...
                                    <div class="td-cont text-center">
                                        <?php if ($is_check < 2) { ?>
                                            <?php if (empty($_SESSION['store']['drp_supplier_id'])) { ?>
                                                <div>
                                                    <a href="javascript:;" data-order-id="<?php echo $order['order_id']; ?>" class="btn btn-small js-comfirm-check">确认对账</a>
                                                </div>
                                            <?php } else { ?>
                                                <div>
                                        ...
                                        <p>
                                            <?php if($is_check == 3) {?>
                                            <a href="<?php dourl('fx:commission_detail', array('id' => $order['user_order_id'])); ?>" class="js-order-detail">分润明细</a>
                                            <?php }else{ ?>
                ...
                <?php foreach ($sellers as $seller) { ?>
                    ...
                    <tr class="widget-list-item">
                        ...
                        <td style="text-align: right">
                            <a href="<?php dourl('order:ws_bill_check', array('store_id' => $seller['store_id'])); ?>#uncheck"><?php echo $seller['uncheck_profit']; ?></a>
                        </td>
                        <td style="text-align: right">
                            <a href="javascript:void(0)"><?php echo $seller['checked_profit']; ?></a>
                        </td>
                        <td style="text-align: right">
                            <a href="<?php dourl('order:ws_bill_check', array('store_id' => $seller['store_id'])); ?>#uncheck"><?php echo $seller['uncheck_order']; ?></a>
                        </td>
                        <!--<td style="text-align: right">
