...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			save_bak_url = "<?php dourl('save_bak'); ?>", 
			image_path = "<?php echo TPL_URL; ?>", 
			add_star_url = "<?php dourl('add_star'); ?>", 
			cancel_status_url = "<?php dourl('cancel_status'); ?>", 
			complate_status_url = "<?php dourl('complate_status'); ?>", 
			detail_json_url = "<?php dourl('detail_json'); ?>", 
			float_amount_url = "<?php dourl('float_amount'); ?>", 
			...
			package_assign_url = "<?php dourl('package_product_physical'); ?>", 
			package_product_phy_url = "<?php dourl('package_product_phy'); ?>", 
			create_package_phy_url = "<?php dourl('create_package_phy'); ?>", 
			package_assign_save_url = "<?php dourl('product_physical_save'); ?>",
			order_download_url="<?php dourl('order_download_csv');?>";
		</script>
