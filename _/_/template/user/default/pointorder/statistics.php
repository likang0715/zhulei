...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>订单统计 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/order_statistics.js"></script>
	</head>
			...
			<div class="app">
				<div class="app-inner clearfix">
					<div class="app-init-container">
						...
						<div class="app__content stat-order"></div>
					</div>
				</div>
			</div>
		</div>
