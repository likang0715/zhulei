		...
		<div class="page-tradeincard">
			...
			<div class="js-page-form form-horizontal ui-form" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="mobile" name="mobile" value="" placeholder="请输入手机号" style="width:100px;">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<input type="text" id="username" name="username" value="" placeholder="请输入账号" style="width:250px;">
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<input type="text" id="terminal_number" name="terminal_number" value="" placeholder="请输入终端号" style="width:300px;">
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<input type="text" id="keys" name="keys" value="" placeholder="请输入密钥" style="width:300px;">
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append">
							<input type="text" id="counts" name="counts" value="" placeholder="请输入份数" style="width:80px;" maxlength="4">
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<ul class="dytype">
							<li><input type="radio" class="print_type" name="print_type" value="1">&nbsp;只打印付过款的</li>
							<li><input type="radio" class="print_type" name="print_type" value="2">&nbsp;无论是否付款都打印</li>
						</ul>	
