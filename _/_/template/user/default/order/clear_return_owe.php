...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>退货欠款销账 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">
			...
			var clear_return_owe_url = "<?php dourl('clear_return_owe'); ?>";
			var dealer_id = "<?php echo $dealer['dealer_id']; ?>";
		</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/clear_return_owe.js"></script>
		<style type="text/css">
			.ui-nav {
				border: none;
				background: none;
				...
				<div class="app-inner clearfix">
					<div class="app-init-container">
							...
							<div class="ui-box settlement-info">
								<div class="balance">
									...
									<div class="balance-info" style="border-left: none; position:relative">
										<div class="balance-title">已销账<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $dealer['clear_return_owe']; ?></span>
											<span class="unit">元</span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">待销账<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $dealer['return_owe']; ?></span>
											<span class="unit">元</span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">经销商<div class="help"></div></div>
										<div class="balance-content">
											<span style="color: #07d;font-size: 15px;"><?php echo $dealer['name']; ?></span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">销账类型<div class="help"></div></div>
										<div class="balance-content">
											<span style="color: black;font-size: 15px;">退货欠款</span>
										</div>
									</div>
						...
						<nav class="ui-nav clearfix">
							<ul class="pull-left">
								<li class="active" data-type="add"><a href="#add">添加销账记录</a></li>
								<li data-type="log"><a href="#log">已销账记录</a></li>
							</ul>
						</nav>
