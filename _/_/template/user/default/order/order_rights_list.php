...
<div class="goods-list">
	<div class="js-list-filter-region clearfix ui-box" style="position: relative;">
		<div>
			<h3 class="list-title js-goods-list-title">维权列表</h3>
		</div>
	</div>
	<div class="ui-box">
			...
			if(is_array($rights_list)) {
				foreach ($rights_list as $rights) { ?>
					<tr>
						...
						<td class="text-center">
							<a href="#detail/<?php echo $rights['id'] ?>" class="js-rights-detail">查看详情</a><br />
							<a href="<?php echo url('order:detail', array('id' => $rights['order_id'])) ?>">订单详情</a>
						</td>
					</tr>
			<?php
				}
