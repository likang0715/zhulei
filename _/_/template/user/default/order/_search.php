    ...
    <div class="clearfix">
        ...
        <div class="pull-left">
            ...
            <div class="filter-groups">
                ...
                <div class="control-group">
                    <div class="controls" <?php if (!empty($drp_teams)) { ?>style="margin-left: 0"<?php } ?>>
                        <div class="ui-btn-group">
                            <?php if (!empty($drp_teams)) { ?>
                            所属团队：
                            <select class="drp_team_id" name="drp_team_id">
                                <option value="">全部</option>
                                <?php foreach ($drp_teams as $drp_team) { ?>
                                <option value="<?php echo $drp_team['pigcms_id']; ?>"><?php echo $drp_team['name']; ?></option>
                                <?php } ?>
                            </select>&nbsp;&nbsp;&nbsp;
                            <?php } ?>
