...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>退货订单管理 - <?php echo $store_session['name']; ?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		var credit = <?php echo json_encode($credit_setting) ?>;
		</script>
        <!-- ▲ Constant JS -->
        <!-- ▼ Base JS -->
