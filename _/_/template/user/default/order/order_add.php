		...
		<div class="app-present app-reward">
			<form class="form-horizontal" id="myformaaaaaaa">
				<div class="present-info">
					...
					.point-type-list .btn {background:white; color:#999; border:1px solid #e5e5e5}
					.point-type-list .orange {color:#f60; border:1px solid #f60}
					</style>
					<div class="control-group js-logistics-container" style="display: none;">
						...
						<div class="js-logistics-content-list">
							...
							<div class="js-logistics content-deteil <?php if ($store['buyer_selffetch'] && !empty($selffetch_list)) { echo 'hide'; } ?>" >
					...
					<div class="control-group js-point-container"  data-point="0" data-point_money="0" data-store_point="<?php echo $store['point_balance'] ?>" style="display: none;">
						<h3 class="present-sub-title js-point-type-list point-type-list">
							积分抵扣
							<a href="javascript:;" data-type="platform" class="cash btn btn-small " style="padding:4px 7px; display:none;">商家积分</a>
							<a href="javascript:;" data-type="user_platform" class="cash btn btn-small" style="padding:4px 7px; display:none;">商家可用积分</a>
							<a href="javascript:;" data-type="user" class="cash btn btn-small orange" style="padding:4px 7px;">用户平台积分</a>
						</h3>
						<div class="content-deteil">
							<div class="reward-table-wrap">
								<table class="reward-table">
									<tr style="display: none;" class="js-store_point_container">
										<td style="line-height: 24px; padding-left: 15px;">
											<input type="checkbox" name="point" value="1" checked="checked" id="point_1" /><label for="point_1" style="display: inline;"><span style="padding-right: 20px; width: 100px;">店铺积分</span><span class="js-point_content">加载中</span></label>
										</td>
									</tr>
									<tr style="display: none;" class="js-platform_point_container">
										<td style="line-height: 24px; padding-left: 15px;">
											<input type="checkbox" name="point" value="1" checked="checked" id="point_2" class="js-platform_point_input" />
											<label for="point_2" style="display: inline;">
												<span style="padding-right: 20px; width: 100px;"><?php echo option('credit.platform_credit_name') ?></span>
											</label>
											<span style="padding-left: 10px;">
												使用<input type="text" name="platform_point" style="width: 50px;" value="0" />,抵现￥<span class="js-platform_point_use_money">0</span>
											</span>
											
											<span style="padding-left: 10px;">
												(您有<span class="js-user_point_balance"></span>,可用<span class="js-platform_point_max">0</span>个)
											</span>
										</td>
									</tr>
									<tr style="display: none;" class="js-store_platform_point_container">
										<td style="line-height: 24px; padding-left: 15px;">
											<input type="checkbox" name="point" value="1" checked="checked" id="point_3" class="js-store_platform_point_input" />
											<label for="point_3" style="display: inline;">
												<span style="padding-right: 20px; width: 100px;"><?php echo option('credit.platform_credit_name') ?></span>
											</label>
											<span style="padding-left: 10px;">
												使用<input type="text" name="store_platform_point" style="width: 50px;" value="0" />,抵现￥<span class="js-store_platform_point_use_money">0</span>
											</span>
											
											<span style="padding-left: 10px;">
												(店铺有<span class="js-store_point_balance"><?php echo $store['point_balance'] ?></span>,可用<span class="js-store_platform_point_max">0</span>个)
											</span>
										</td>
									</tr>
									<tr style="display: none;" class="js-user_platform_point_container">
										<td style="line-height: 24px; padding-left: 15px;">
											<input type="checkbox" name="point" value="1" checked="checked" id="point_4" class="js-user_platform_point_input" />
											<label for="point_4" style="display: inline;">
												<span style="padding-right: 20px; width: 100px;"><?php echo option('credit.platform_credit_name') ?></span>
											</label>
											<span style="padding-left: 10px;">
												使用<input type="text" name="user_platform_point" style="width: 50px;" value="0" />,抵现￥<span class="js-user_platform_point_use_money">0</span>
											</span>
											
											<span style="padding-left: 10px;">
												(店铺用户有<span class="js-user_store_point_balance"><?php echo $point_balance ?></span>,可用<span class="js-user_platform_point_max">0</span>个)
											</span>
										</td>
									</tr>
								</table>
					...
					<div class="control-group js-reward-container" style="display: none;">
						...
						<div class="content-deteil">
							<div class="reward-table-wrap">
								<table class="reward-table js-reward-table" data-has_reward="0">
									<!-- 
									<tr>
										<td style="line-height: 24px; padding-left: 15px;">
											商品金额
					...
					<div class="control-group js-coupon-container" style="display: none;">
						...
						<div class="content-deteil">
							<div class="reward-table-wrap">
								<table class="reward-table js-coupon-table" data-has_coupon="0">
									<!-- 
									<tr>
										<td style="line-height: 24px; padding-left: 15px;">
								...
								<table class="reward-table">
									<tr>
										<td style="text-align: center; font-size:16px; line-height:24px;padding:10px 0px;">
											...
											<span id="js-reward_span">- ￥<span id="js-reward">0.00</span>满减</span>
											<span id="js-user_coupon_span">- ￥<span id="js-user_coupon">0.00</span>优惠券</span>
											<span id="js-discount_money_span">- ￥<span id="js-discount_money">0.00</span>元折扣</span>
											<span style="display: none;">- 减免￥<span id="js-float_amount">0.00</span></span>
											<span id="js-point_money_span">- ￥<span id="js-point_money">0.00</span>元积分抵扣</span>
											<span class="js-platform_point_money" style="display: none;">
												 - ￥<span></span>元<?php echo option('credit.platform_credit_name') ?>抵扣
											</span><br/>
			...
			<div class="app-design js-submit-container" style="display: none;">
				<div class="control-group">
					<h3 class="present-sub-title">
						备注 <input type="text" class="js-bak" style="width:80%; " maxlength="500" />
					</h3>
				</div>
