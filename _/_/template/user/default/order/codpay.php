...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>货到付款订单 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/order_print_checkout.js"></script>
 		<script type="text/javascript" src="<?php echo TPL_URL;?>js/order_codpay.js"></script>
