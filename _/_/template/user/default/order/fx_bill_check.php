			...
			<div class="app">
                <div class="dash-bar clearfix" style="margin-top: 15px">
                    <div class="js-cont">
                        ...
                        <?php } else { ?>
                        <div class="info-group" style="padding: 0px;">
                            <div class="info-group__inner">
                                <span class="h4" style="font-size: 16px;display: inline-block;width: 180px;margin-top: 15px;white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                                    <a href="javascript:void(0);" title="<?php echo $store['name']; ?>"><?php echo $store['name']; ?></a>
                                </span>
                            </div>
                        </div>
                        <?php } ?>
