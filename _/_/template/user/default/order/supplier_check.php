					...
					<div class="app-init-container">
						<div class="page-settlement">
							<div class="ui-box settlement-info">
								...
								<div class="balance">
									<div class="balance-info" style="position:relative">
										<div class="balance-title">经销分红奖金<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $dividends_total; ?></span>
											<span class="unit">元</span>&nbsp;
											<span class="unit"><a href="javascript:;" class="js-dividends-mx">明细</a></span>
										</div>
									</div>
									<div style="clear: both"></div>
								</div>
						...
						<nav class="ui-nav clearfix">
							<ul class="pull-left">
								...
								<li data-checked="3"><a href="#dividends_mx">分红奖金</a></li>
							</ul>
						</nav>
