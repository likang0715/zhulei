...
<?php foreach($order_all as $k=>$order) {?>
	...
	<td height="70">
		<table cellpadding="0" cellspacing="0" class="table_style" style="width: 100%">
			<tr>
				...
				<td align="right"><img width="120" height="120" src="<?php echo $order['store']['qcode']?>"/></td>
			</tr>
		</table>
	</td>
</tr>
...
<tr>
	<td align="center">
		...
		$total_money = 0;
		$discount_money = 0;
		foreach ($order['products_list'] as $key => $product) {
...
<tr>
	<td>
	<table cellpadding="3" cellspacing="0" class="table_style" style="width: 100%;padding-bottom:100px;">
		<tr>
			<?php
			if($order['comment'] || 1) {
			?>
...
<div id="divTest" class=noprint style="position:fixed;z-index:1000;background-color:#D5ECF1;width:100%;height:50px;bottom:0px;">
<OBJECT classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2" height="0" id="wb" name="wb" width="0" VIEWASTEXT></OBJECT><input type=button name=button_show value="打印预览" class="noprint" onclick="javascript:wb.execwb(7,1);"> <input type=button name=button_show value="打印设置" class="noprint" onclick="javascript:wb.execwb(8,1);"> <input type="button" id="datasubmit" value="确认打印" name="submit" onclick="javascrīpt:window.print()"></div>
