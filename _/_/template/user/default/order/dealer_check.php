...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>经销商对账详情 - <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">
			...
			var page_content = "dealer_check_content";
		</script>
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/dealer_check.js"></script>
		<style type="text/css">
			.ui-nav {
				border: none;
				background: none;
				...
				<div class="app-inner clearfix">
					<div class="app-init-container">
							...
							<div class="ui-box settlement-info">
								<div class="balance">
									...
									<div class="balance-info" style="border-left: none; position:relative">
										<div class="balance-title">已收款<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $paid_total; ?></span>
											<span class="unit">元</span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">待收款<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $not_paid_total; ?></span>
											<span class="unit">元</span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">待收退货款<div class="help"></div></div>
										<div class="balance-content">
									...
									<div class="balance-info" style="position:relative">
										...
										<div class="balance-content">
											<span class="money"><?php echo $dealers_count; ?></span>
											<span class="unit">家</span>
										</div>
									</div>

									<div class="balance-info" style="position:relative">
										<div class="balance-title">销售额<div class="help"></div></div>
										<div class="balance-content">
											<span class="money"><?php echo $sales; ?></span>
											<span class="unit">元</span>
										</div>
									</div>
						...
						<nav class="ui-nav clearfix">
							<ul class="pull-left">
								<li class="active" data-checked="1"><a href="#bond-pay">已缴纳保证金</a></li>
								<li data-checked="2"><a href="#cash-pay">未缴纳保证金</a></li>
							</ul>
						</nav>
