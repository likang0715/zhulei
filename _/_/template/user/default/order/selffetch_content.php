        ...
        <div>
            ...
            <div class="ui-nav">
                <ul>
                    ...
                    <li><a href="javascript:;" class="wait-send status-2" data="2">待提货</a></li>
                    <li><a href="javascript:;" class="shipped status-4" data="4">已完成</a></li>
                    <li><a href="javascript:;" class="success status-5" data="5">已关闭</a></li>
                    <li><a href="javascript:;" class="success status-6" data="6">退款中</a></li>
                    <li><a href="javascript:;" class="canceled status-7" data="7">已自提</a></li>
                </ul>
            </div>
