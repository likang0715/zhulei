...
<form class="form-horizontal" style="">
	...
	<div class="control-group">
        ...
        <div class="controls ui-regions js-regions-wrap">
            <span>
                <select name="group" id="store_id">
                    <option value="1" <?php if($userInfo['group']=='1'){?> selected="selected"<?php }?>>总店管理员</option>
                    <option value="2" <?php if($userInfo['group']=='2'){?> selected="selected"<?php }?>>门店管理员</option>
                </select>
            </span>
        </div>
    </div>
	...
	<div class="control-group" style="display:none;">
        ...
        <?php if(is_array($methodList['events'])){ ?>
         <div class="controls">
            <input type="hidden" class="js-not-autoup" name="events_control" value="events">
            <label class="checkbox inline">
                <input type="checkbox" class="js-not-autoup" name="events[]" <?php echo in_array('list', $methodList['events']) ? 'checked' : '';?> value="list">茶会列表
            </label>
            <label class="checkbox inline">
                <input  type="checkbox" class="js-not-autoup" name="events[]" <?php echo in_array('edit', $methodList['events']) ? 'checked' : '';?> value="edit">茶会编辑
            </label>
			<label class="checkbox inline">
                <input  type="checkbox" class="js-not-autoup" name="events[]" <?php echo in_array('order', $methodList['events']) ? 'checked' : '';?> value="order">报名审核
            </label>
             </div>
            <?php }else{ ?>
             <div class="controls">
            <input type="hidden" class="js-not-autoup" name="events_control" value="events">
            <label class="checkbox inline">
                <input type="checkbox" class="js-not-autoup" name="events[]" value="list">茶会列表
            </label>
            <label class="checkbox inline">
                <input  type="checkbox" class="js-not-autoup" name="events[]" value="edit">茶会编辑
            </label>
			<label class="checkbox inline">
                <input  type="checkbox" class="js-not-autoup" name="events[]" value="order">报名审核
            </label>
        </div>
       <?php } ?>
    </div>
    ...
    <div class="form-actions" style="margin-top:50px">
        <button type="button" id="sub-button" class="ui-btn ui-btn-primary js-admin-submit">修改</button>
    </div>
</form>
