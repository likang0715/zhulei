        ...
        <div class="js-list-filter-region clearfix">
            <div class="widget-list-filter">
                <div class="ui-box dianpu">
                    <a class="ui-btn ui-btn-green" href="#admin_add">新建</a>
                </div>
            </div>
        </div>
            ...
            <table class="ui-table ui-table-list physical_list">
                ...
                <?php foreach($store_admin_list as $value){ ?>
                    <tr class="widget-list-item">
                        ...
                        <td class="dianpu">
                            <a href="#admin_edit/<?php echo $value['uid'];?>" class="js-edit">编辑</a> - <a href="javascript:;" class="js-delete-admin" data-id="<?php echo $value['uid'];?>">删除</a>
                        </td>
