<form class="form-horizontal" style="">
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" class="js-mobile" name="mobile" placeholder="请输入手机号码" value="<?php echo $store_contact['mobile']?>" minlength="11" maxlength="11"/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" name="shortdesc" placeholder="用一句话介绍茶馆，体现茶馆文化气息" value="" maxlength="30" style="width:320px"/>
		</div>
	</div>
    <div class="control-group">
        <label class="control-label">
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" name="price" placeholder="平均价位" value="<?php echo $store_contact['price']?>"/>元/人
		</div>
	</div>
	<div class="control-group">
        <label class="control-label">
