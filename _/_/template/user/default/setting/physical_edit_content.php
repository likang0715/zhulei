<form class="form-horizontal" style="">
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" class="js-mobile"  name="mobile" placeholder="请输入手机号码" value="<?php echo $store_physical['mobile']?>" maxlength="15"/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">
            ...
            <div class="control-action js-picture-list-wrap">
				<ul class="app-image-list clearfix">
					<div class="js-img-list" style="display:inline-block">
						<li class="upload-preview-img"><a href="<?php echo $store_physical['images']?>" target="_blank"><img src="<?php echo $store_physical['images']?>"></a><a class="js-delete-picture close-modal small hide">×</a></li>
					</div>
					<li class="js-picture-btn-wrap" style="display:inline-block;float:none;vertical-align:top;">
						<a href="javascript:;" class="add js-add-physical-picture">+修改</a>
					</li>
				</ul>
			</div>
        </div>
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" name="shortdesc" placeholder="用一句话介绍茶馆，体现茶馆文化气息" value="<?php echo $store_physical['shortdesc']?>"  maxlength="30" style="width:320px"/>
		</div>
	</div>
	<div class="control-group">
        <label class="control-label">
        ...
        <div class="controls">
            <div class="control-action js-picture-list-wrap">
				<ul class="app-image-list clearfix">
					<div class="js-pic-list" style="display:inline-block">
						<?php foreach($store_physical['pics'] as $value){ ?>
							<li class="upload-preview-pic"><a href="<?php echo $value;?>" target="_blank"><img src="<?php echo $value;?>"></a><a class="js-delete-picture close-modal small hide">×</a></li>
						<?php } ?>
					</div>
					<li class="js-picture-btn-wrap" style="display:inline-block;float:none;vertical-align:top;">
						<a href="javascript:;" class="add js-add-pic">+加图</a>
					</li>
				</ul>
			</div>
        </div>
	...
	<div class="control-group">
		...
		<div class="controls">
		<input type="text" name="price" placeholder="平均价位" value="<?php echo $store_physical['price']?>"/>元/人
		</div>
	</div>
	<div class="control-group">
        <label class="control-label">
	...
	<?php foreach($keyword as $value){ ?>
							<li><?php echo $value['name'];?>-<?php echo $value['id'];?></li>
						<?php } ?>
		</div>	
