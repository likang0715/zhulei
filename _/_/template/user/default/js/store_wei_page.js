	...
	$('.js-help-notes').live('mouseenter mouseleave', function(e) {
		...
		if (e.type == 'mouseenter') {
			if ($('.js-intro-popover.homepage-qrcode').size() > 0) {
				...
				if (right<160) {
					$('.js-intro-popover.homepage-qrcode').css({
						'top': $(this).offset().top - 117,
						'left': $(this).offset().left - 210
					});
				} else{
					$('.js-intro-popover.homepage-qrcode').css({
						'top': $(this).offset().top + $(this).height() + 5,
						'left': $(this).offset().left + ($(this).width() / 2) - 95
					});
				};
			} else {
				if (right<160) {
					$('body').append('<div class="js-intro-popover popover popover-intro left center homepage-qrcode" style="display:top;top:' + ($('.js-help-notes').offset().top - 117) + 'px;left:' + ($('.js-help-notes').offset().left - 210) + 'px;"><div class="arrow"></div><div class="popover-inner"><div class="popover-content">' + ($('.js-notes-cont').html()) + '</div></div></div>');
				} else{
