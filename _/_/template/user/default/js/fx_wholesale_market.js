...
var checked=1;
$(function(){
    load_page('.app__content', load_url, {page:'wholesale_market_content', 'checked': checked}, '', function(){
    ...
    $('.pagenavi > a').live('click', function(e){
		...
		text = $('.result-selected').text()?$('.result-selected').text():'所有分类';
		        $('.app__content').load(load_url, {page: 'wholesale_market_content', 'p': p,'store_name': keyword, 'category_id': category_id, 'category_fid': category_fid, 'checked': checked}, function(){
    ...
    $('.active-result').live('click', function(){
        ...
        load_page('.app__content', load_url, {page: 'wholesale_market_content', 'category_id': category_id, 'category_fid': category_fid, 'store_name': keyword, 'checked': checked}, '', function(){
            $('.chosen-single > span').text(text);
            $('.active-result').not(index).removeClass('result-selected highlighted')
            $('.active-result').eq(index).addClass('result-selected highlighted');
			$('.js-list-search > .js-keyword').val(keyword);
    ...
    $('.market-search-btn').live('click', function(){
        var keyword = $.trim($('.js-list-search > .js-keyword').val());
		text = $('.result-selected').text();
        load_page('.app__content', load_url, {page: 'wholesale_market_content', 'store_name': keyword, 'category_id': category_id, 'category_fid': category_fid, 'checked': checked}, '', function(){
            $('.chosen-single > span').text(text);
            $('.active-result').not(index).removeClass('result-selected highlighted')
            $('.active-result').eq(index).addClass('result-selected highlighted');
            $('.js-list-search > .js-keyword').val(keyword);
