...
$(function() {
	...
	$(".js_edit_jifen").live("click",function(e) {
		...
		button_box_self($(this), e, 'left', 'multi_txt', edit_html, function(){
	...
	if(type=='edit_txt'){
       ...
       // $('.popover-chosen .select2-input').attr('placeholder', content).focus();
		...
		var tanchu  = '<div class="popover ' + position + '" style="left:-' + ($(window).width() * 5) + 'px;top:' + $(window).scrollTop() + 'px;">';
			...
			tanchu += '							<input id="jf_before" type="button"  value="-" style="text-align:center;cursor:pointer;display:inline-block;margin-right: -5px;border: 1px solid #ccc;width: 28px;">';
			tanchu += '								<input id="jf_change" value="0" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input" id="s2id_autogen26" tabindex="-1" maxlength="5" size="5" style="width:40px;backgroun-image:-webkit-gradient(linear, 0% 0%, 0% 100%, color-stop(1%, #eee), color-stop(15%, #fff));border: 1px solid #ccc;border-radius: 0;height: 16px;margin: 0;margin-top: -2px;text-align: center;">';
			tanchu += '							<input id="jf_after" type="button" value="+" style="text-align:center;border:1px solid #ccc;display:inline-block;width: 28px;margin-left: -5px;">';
