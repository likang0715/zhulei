...
$(function() {
    ...
    load_page('.app__content',load_url,{'page': 'margin_details_content', 'type': type},'', function () {
        $(".js-type-select").val(type);
    });
    ...
    $('.pagenavi > a').live('click', function(e){
        ...
        load_page('.app__content', load_url, {'page': 'margin_details_content', 'p': p, 'order_no': order_no, 'start_time': start_time, 'stop_time': stop_time, 'type': type}, '', function(e){
            if (order_no != '') {
