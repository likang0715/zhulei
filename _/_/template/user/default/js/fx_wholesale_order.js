...
$(function(){
    load_page('.app__content', load_url, {page:'wholesale_order_content'}, '');
    ...
    $('.js-filter').live('click', function(){
        ...
        fx_order_no = $.trim($("input[name='fx_order_no']").val());
        delivery_user = $.trim($("input[name='delivery_user']").val());
        ...
        delivery_tel = $.trim($("input[name='delivery_tel']").val());

        load_page('.app__content', load_url, {page:'wholesale_order_content', 'p': p, 'order_no': order_no, 'fx_order_no': fx_order_no, 'delivery_user': delivery_user, 'start_time': start_time, 'stop_time': stop_time, 'supplier_id': supplier_id, 'status': status, 'delivery_tel': delivery_tel}, '', function(){
            if (order_no != '') {
                $("input[name='order_no']").val(order_no);
            }
            if (fx_order_no != '') {
                $("input[name='fx_order_no']").val(fx_order_no)
            }
            if (delivery_user != '') {
    ...
    $('.pagenavi > a').live('click', function(){
        ...
        status = $.trim($("select[name='state']").val());
        delivery_tel = $.trim($("input[name='delivery_tel']").val());
        load_page('.app__content', load_url, {page:'wholesale_order_content', 'p': p, 'order_no': buyer_order_no, 'fx_order_no': seller_order_no, 'delivery_user': delivery_user, 'start_time': start_time, 'stop_time': stop_time, 'supplier_id': supplier_id, 'status': status, 'delivery_tel': delivery_tel}, '', function(){
            if (buyer_order_no != '') {
