...
$(function(){
    load_page('.app__content', load_url, {page:'seller_order_content'}, '');
    ...
    $('.js-filter').live('click', function(){
       ...
       var delivery_tel = $.trim($("input[name='delivery_tel']").val());
        ...
        load_page('.app__content', load_url, {page:'seller_order_content', 'p': p, 'order_no': order_no, 'fx_order_no': fx_order_no, 'delivery_user': delivery_user, 'start_time': start_time, 'end_time': end_time, 'supplier_id': supplier_id, 'status': status, 'delivery_tel': delivery_tel}, '', function(){
            if (fx_order_no != '') {
    ...
    $('.pagenavi > a').live('click', function(){
        ...
        var status = $.trim($("select[name='state']").val());
        var delivery_tel = $.trim($("input[name='delivery_tel']").val());
        load_page('.app__content', load_url, {page:'seller_order_content', 'p': p, 'order_no': buyer_order_no, 'fx_order_no': seller_order_no, 'delivery_user': delivery_user, 'start_time': start_time, 'end_time': end_time, 'supplier_id': supplier_id, 'status': status, 'delivery_tel': delivery_tel}, '', function(){
            if (buyer_order_no != '') {
