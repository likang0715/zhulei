...
<ul class="ui-nav-tab">
	<li data-next-step="1" class="js-switch-step js-step-1"><a href="javascript:;">1.选择积分商品品类</a></li>
	<li data-next-step="2" class="js-switch-step js-step-2 active"><a href="javascript:;">2.编辑基本信息</a></li>
	<li data-next-step="3" class="js-switch-step js-step-3"><a href="javascript:;">3.编辑积分商品详情</a></li>
</ul>
		...
		<div class="info-group-cont vbox">
			<div class="group-inner">
				<div class="control-group">
					<label class="control-label">积分商品类目：</label>
				...
				<div class="control-group" style="display: none">
					...
					<div class="controls">
						...
						<label class="radio inline">
							...
							<span class="js-outbuy-tip hide">(每家店铺仅支持50个外部购买积分商品)</span>
						</label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">积分商品分组：</label>
					<div class="controls">
						<select class="js-tag chosen-select" name="tag" multiple="" data-placeholder="选择积分商品分组" style="display:none;"></select>
							...
							<ul class="chosen-choices">
								<?php if($group_groups){ ?>
									...
									<li class="search-field">
										<input type="text" value="选择积分商品分组" class="default" autocomplete="off" style="cursor:text;width:25px;" readonly="readonly"/>
									</li>
								<?php }else{ ?>
									<li class="search-field">
										<input type="text" value="选择积分商品分组" class="default" autocomplete="off" style="cursor:text;width:103px;" readonly="readonly"/>
									</li>
								<?php } ?>
			...
			<div class="group-inner">
				...
				?>
					<div class="js-goods-sku control-group">
						<label class="control-label">积分商品属性：</label>
				...
				<div class="js-goods-stock control-group" <?php if (empty($sku_content)) { ?>style="display: none;"<?php } ?>>
					<label class="control-label">积分商品库存：</label>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php if (!$product['show_sku']) { ?>checked="true" <?php } ?> />页面不显示积分商品库存</label>
						<p class="help-desc">总库存为 0 时，将不在积分商品列表中显示</p>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">积分商品编码：</label>
...
<div id="goods-info-region" class="goods-info-group">
	<div class="goods-info-group-inner">
		<div class="info-group-title vbox">
			<div class="group-inner">积分商品信息</div>
		</div>
		<div class="info-group-cont vbox">
			<div class="group-inner">
				<div class="control-group">
					<label class="control-label"><em class="required">*</em>积分商品名：</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<p class="tip" style="color: red">* <b>温馨提示：</b>您批发过来的积分商品建议价格区间为 <?php echo $product['sale_min_price'].' - '.$product['sale_max_price'];?></p>
					<?php }?>
					...
					<div class="controls">
						...
						<input type="text" style="display:none;" class="input-small" placeholder="关注后价格：" name="after_subscribe" <?php if ($product['after_subscribe_price'] > 0) { ?>value="<?php echo $product['after_subscribe_price']; ?>"<?php } ?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on">￥</span><input type="text" maxlength="10" name="origin" <?php if ($product['original_price'] > 0) { ?>value="<?php echo $product['original_price']; ?>"<?php } ?> class="input-small"/>
						</div>
						<input type="text" style="display:none" class="input-small" placeholder="关注后价格：" name="after_subscribe" <?php if ($product['after_subscribe_price'] > 0) { ?>value="<?php echo $product['after_subscribe_price']; ?>"<?php } ?> />
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend">
							...
							<input type="text"  class="input-small" placeholder="" name="price" maxlength="10" value="<?php echo (int)$product['price']; ?>"/>
						</div>
				...
				<div class="control-group">
					<label class="control-label"><em class="required">*</em>积分商品图：</label>
					<div class="controls">
			...
			<div class="group-inner">
				...
				<div class="control-group">
					...
					<div class="controls" style="color:orangered">
						<?php if (!empty($product['wholesale_product_id'])) { ?>
							该积分商品为批发积分商品，暂不支持修改运费、配送信息
						<?php } else { ?>
							该积分商品为分销积分商品，暂不支持修改运费、配送信息
						<?php } ?>
					</div>
					<?php } ?>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox inline">
							<input type="checkbox" name="is_recommend" value="1" <?php if ($product['is_recommend']) { echo 'checked="true"';} ?> /> 参加推荐
						</label>
	...
	<div class="app-design clearfix">
		...
		<div class="app-sidebar" style="margin-top: 243px;" <?php echo !empty($product['wholesale_product_id']) ? 'disabled' : '';?>>
			<div class="app-sidebar-inner goods-sidebar-sub-title js-goods-sidebar-sub-title hide"
				 style="display: block;">
				<p class="" style="color: #333">积分商品简介(选填)</p>
