...
<div class="goods-list">
	<div class="js-list-filter-region clearfix ui-box" style="position: relative;">
		<div>
			<h3 class="list-title js-goods-list-title">仓库中的礼物</h3>
			...
			<span style="background-color:#e5e5e5;display:inline-block;">
				<select id="select_level" style="height: auto;line-height: normal;width: auto;font-size: 12px;font-family: Helvetica,STHeiti,'Microsoft YaHei',Verdana,Arial,Tahoma,sans-serif;">
					<option value="soldout">导出当前类别礼物</option>
					<option value="all">导出全部礼物</option>
				</select>
				<input type="button" class="ui-btn ui-btn-primary js-dump-btn" value="礼物导出">
			</span>
			</div>
			   <?php }?>
			<!-- ----------- -->
			...
			<div class="ui-block-head-help soldout-help js-soldout-help hide" style="display: none;">
				...
				<div class="js-notes-cont hide">
					<p>当礼物的所有规格或者某一个规格的库存变为0时，将显示在已售罄的礼物列表中</p>
				</div>
			</div>
		...
		<table class="ui-table ui-table-list" style="padding: 0px;">
			...
			<tr>
				<th class="checkbox cell-35" colspan="3" style="min-width: 332px; max-width: 332px;">
					<label class="checkbox inline"><input type="checkbox" class="js-check-all">礼物</label>
				...
				<tr>
					...
					<td class="text-right">
						<p>
							...
							<!-- <span>-</span> 	
								<a href="javascript:void(0);" class="js-promotion-btn" data="<?php echo $product['product_id']; ?>">推广礼物</a>
							-->
						</p>
