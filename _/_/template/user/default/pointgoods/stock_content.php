    ...
    <div class="ui-box">
        <table class="ui-table ui-table-list" style="padding: 0px;">
            ...
            <tr>
                ...
                <th class="cell-8 text-right" style="min-width: 68px; max-width: 68px;">本店库存</th>
            ...
            <?php foreach ($products as $product) { ?>
                <tr>
                    ...
                    <td class="goods-meta">
                        ...
                        <p>
                            ...
                            <?php } else if (!empty($allow_store_drp) && !empty($product['supplier_id'])) { ?>
                    ...
                    <td class="">
                        <?php if (empty($product['has_property'])) {
                            echo $product['_physical_quantity'];
                        } else {
                            echo '----';
                        } ?>
                    </td>
                ...
                <?php if (!empty($product['has_property']) && !empty($product['sku'])) { //商品规格列表 ?>
                    ...
                    <tr>
                        ...
                        <td class="">----</td>
                        <td class=""><?php echo $product_sku['_physical_quantity']; ?></td>
                        <td class="text-right">
                            <p>
