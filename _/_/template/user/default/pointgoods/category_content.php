<div>
    <div class="js-list-filter-region clearfix ui-box" style="position:relative;">
        <div>
			<a href="#create" class="ui-btn ui-btn-primary">新建礼物分组</a>
			...
			<table class="ui-table ui-table-list" style="padding:0px;">
				<thead class="js-list-header-region tableFloatingHeaderOriginal">
					<tr>
						...
						<th class="cell-10 text-right"><a href="javascript:;" data-orderby="feature_count">礼物商品数</a></th>
				...
				<tbody class="js-list-body-region">
					<?php foreach($group_list['group_list'] as $value){ ?>
						<tr group-id="<?php echo $value['group_id']?>">
							...
							<td class="text-right"> <?php if($value['product_count']){echo $value['product_count'];}else {echo "0";}?></td>
