...
var styleMod1={
    ...
    element:[
        ...
        {type:'textarea',x:230,y:34,color:'#ffffff',size:14,content:[
            {text:'我为'},
            {text:'{$company}',color:'#fff600'},
            {text:'代言'}
        ]},
        {type:'textarea',x:100,y:70,color:'#ffffff',size:14,display:1,content:[
            {text:'推广时间：{$start_time}至{$end_time}',color:'#ffffff',size:14}
        ]},
        {type:'qrcode',width:122,height:122,x:265,y:122},
        {type:'textarea',width:240,height:72,x:10,y:123,color:'#fff',size:14,content:[{text:'{$desc}'}]},
...
var styleMod2={
    ...
    element:[
        ...
        {type:'textarea',x:110,y:65,color:'#ffffff',size:14,content:[
            {text:'我为'},
            {text:'{$company}',color:'#fff600'},
            {text:'代言'}
        ]},
        {type:'textarea',x:40,y:470,color:'#ffffff',size:14,display:1,content:[
            {text:'推广时间：{$start_time}至{$end_time}',color:'#ffffff',size:14}
        ]},
        {type:'qrcode',width:180,height:180,x:65,y:215},
        {type:'textarea',width:290,height:72,x:18,y:130,color:'#fff',size:14,content:[{text:'{$desc}'}]},
...
var styleMod3={
    ...
    element:[
        ...
        {type:'textarea',x:40,y:295,color:'#ffffff',size:14,display:1,content:[
            {text:'推广时间：{$start_time}至{$end_time}',color:'#ffffff',size:14}
        ]},
        {type:'qrcode',width:122,height:122,x:185,y:125},
        {type:'textarea',width:160,height:110,x:10,y:125,color:'#fff',size:14,content:[{text:'{$desc}'}]},
