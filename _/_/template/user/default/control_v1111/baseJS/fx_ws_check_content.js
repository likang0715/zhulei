...
var checked = 1;
$(function() {
    load_page('.app__content', load_url, {page:'ws_bill_check_content', 'p': page, 'checked': checked, 'store_id': store_id}, '', function(){});
})
...
$('.js-comfirm-check').live('click', function(e) {
    ...
    button_box($(this), e, 'left', 'confirm', '确认对账？', function(){
        $.post(bill_check_url, {'order_id': order_id}, function(data){
            if (!data.err_code) {
