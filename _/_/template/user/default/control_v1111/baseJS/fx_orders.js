...
$(function(){
    ...
    $('.js-filter').live('click', function(){
        ...
        load_page('.app__content', load_url, {page:'orders_content', 'p': p, 'order_no': order_no, 'delivery_user': delivery_user, 'start_time': start_time, 'end_time': end_time,'status': status, 'delivery_tel': delivery_tel}, '', function(){
            if (order_no != '') {
