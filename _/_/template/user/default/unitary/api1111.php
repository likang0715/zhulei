...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>营销活动	- <?php echo $store_session['name'];?> | <?php echo $config['site_name'];?></title>
			...
			<div class="app">
				<div class="app-inner clearfix">
					<div class="app-init-container">
						...
						<!---<iframe style="min-height:1550px;" marginheight="0" marginwidth="0" frameborder="0" width="100%" id="iframepage" name="iframepage" class="wt" onLoad='iFrameHeight()' src="<?php echo $synUrl;?>"> 2015/10/16 jjf
						</iframe>---->
						<?php include display('Unitary_index');?>
						</div>
					</div>
				</div>
			</div>
