			...
			<tbody class="js-list-body-region">
				<?php foreach($lucknum_list as $lucknum) { ?>
					<tr class="js-present-detail">
						<td>
							<img src="<?php echo getAttachmentUrl($lucknum['avatar']); ?>" class="user_avatar">
							<br>
						...
						<td class="text-right">
						<?php if ($lucknum['state'] == 1 && !empty($lucknum['order'])) { ?>
							<a href="<?php dourl('order:detail', array('id'=>$lucknum['order']['order_id'])) ?>" target="_blank">去查看订单</a>
						<?php } ?>
						</td>
					</tr>
				<?php } ?>
