	...
	<div class="page-presale clearfix">
		<div class="app-presale app-reward">
			<form class="form-horizontal" id="myformaaaaaaa">
				<input type="hidden" name="id" id="unitary_id" value="<?php echo $unitary['id'] ?>">
				<div class="presale-info">
					<div class="js-basic-info-region">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name" value="<?php echo $unitary['name'] ?>" id="name" placeholder="请填写名称" style="width: 300px;" />
								<em class="error-message"></em>
							</div>
						</div>
						<div class="control-group">
							<input type="hidden" name="logopic" value="<?php echo getAttachmentUrl($unitary['logopic']) ?>">
							<label class="control-label">
							...
							<div class="controls">
								<ul class="ico app-image-list js-logo">
									<li class="sort">
										<a href="javascript:void(0)" target="_blank"><img src="<?php echo getAttachmentUrl($unitary['logopic']) ?>"></a>
										<a class="js-delete-picture close-modal small hide">×</a></li>
									<li class="hide"><a href="javascript:;" class="add-goods js-add-logo">选图片</a></li>
								</ul>
							</div>
						</div>
						<div class="control-group">
							<input type="hidden" name="product_id" value="<?php echo $unitary['product_id'] ?>">
							<input type="hidden" name="sku_id" value="<?php echo $unitary['sku_id'] ?>">
							<label class="control-label">
								<em class="required"> *</em>选择夺宝商品：
							</label>
							<div class="controls">
								<ul class="ico app-image-list js-product">
									<?php 
									if (!empty($product)) {
									?>
										<li class="sort" data-pid="<?php echo $product['product_id'] ?>">
											<a href="<?php echo $product['url'] ?>" target="_blank">
												<img data-pid="<?php echo $product['product_id'] ?>" src="<?php echo getAttachmentUrl($product['image']) ?>" alt="<?php echo htmlspecialchars($product['name']) ?>" />
											</a>
									...
									?>
									<li class="hide"><a href="javascript:;" class="add-goods js-add-picture">选商品</a>  </li>
								</ul>
							</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="price" value="<?php echo $unitary['price'] ?>" style="width: 100px;" />
							<span style="padding-top: 5px; color: red;">
								价格必须输入整数。
							</span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="item_price" value="<?php echo $unitary['item_price'] ?>" style="width: 100px;" />
							<span style="padding-top: 5px; color: red;">
								价格必须输入整数。
							</span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<span class="total_num" style="margin-top:5px;float:left;"><?php echo $unitary['total_num'] ?></span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="opentime" value="<?php echo $unitary['opentime'] ?>" style="width: 30px;" /> 分钟
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
						...
						<div class="controls">
							<textarea rows="5" cols="55" style="width:65%" name="descript" class="descript"><?php echo $unitary['descript'] ?></textarea>
						</div>
					</div>
				</div>
			</form>
