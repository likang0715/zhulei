...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/shakelottery.js?ii=<?php echo rand(1,99999); ?>"></script>
		<script type="text/javascript">
			var index_url = "<?php dourl('shakelottery:shakelottery_index') ?>";
