				...
				<div class="presale-info">
					<div class="js-basic-info-region">
						<div class="control-group">
							...
							<input type="hidden" name="prizeimg" value="">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="prizename" value="" id="prizename" placeholder="请填写名称" style="width: 300px;" />
								<em class="error-message"></em>
							</div>
						</div>
					</div>
					<div class="control-group sku" style="display: none;">
						<label class="control-label">
							<em class="required"> *</em>库存数量：
						</label>
						<div class="controls">
							<input type="text" name="skunub" style="width: 100px;" disabled="" value="0" />
							<span style="padding-top: 5px; color: red;">
								禁止修改
							</span>
						</div>
