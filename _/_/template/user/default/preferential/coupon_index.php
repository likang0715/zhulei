	...
	if($coupon_list) {
		...
		<table class="ui-table ui-table-list" style="padding:0px;">
			...
			<?php foreach($coupon_list as $coupon){ ?>
				<tr class="js-present-detail" data-store-id="<?php echo $store_session['store_id'];?>" service_id="<?php echo $coupon['id']?>">
					...
					<td class="text-right js-operate" data-store-id="<?php echo $store_session['store_id'];?>" data-coupon_id="<?php echo $coupon['id'] ?>">
