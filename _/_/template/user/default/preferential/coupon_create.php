				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline">
							...
							<input name="coupon_type" type="radio" value="1" >
							优惠券
							</span>
							<span class="coupon_span">		
							<input name="coupon_type" style="margin-left:45px;float:none" type="radio" value="2" >
							赠送券
							</span>
						</label>
					</div>
...
-->
				...
				<div class="control-group">
					...
					<div class="controls ">
						...
						<a href="" class="new-window" target="_blank">新建</a>
					</div>
				</div>
