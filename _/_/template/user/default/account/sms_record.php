...
<head>
    ...
    <title id="js-meta-title">购买短信记录 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
	...
	<script type="text/javascript">var load_url="<?php dourl('load');?>", buysms_url="<?php dourl('buysms'); ?>",dobuysms_record_url="<?php dourl("account:sms_record")?>", dobuysms_url="<?php dourl('account:dobuysms'); ?>", select_url="<?php dourl('store:select'); ?>";</script>
