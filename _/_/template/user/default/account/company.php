...
<head>
	...
	<script type="text/javascript">var load_url="<?php dourl('load');?>", company_url="<?php dourl('company'); ?>", select_url="<?php dourl('store:select'); ?>";</script>
						...
						<div class="team">
							<div class="wrapper-app">
                                <div id="header">
                                    <div class="addition">
                                        <div class="user-info">
                                            <span class="avatar" style="background-image:url(<?php if ($avatar) { ?><?php echo $avatar; ?><?php } else { ?>./static/images/avatar.png<?php } ?>)"></span>
