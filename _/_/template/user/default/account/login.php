...
<div id="loginWrap" class="wrap" style="background-image:url(<?php echo TPL_URL;?>images/1yuan_2.jpg)">
                   ...
                   <tr id="line_1" class="line_1">
                    ...
                    <tr id="line_2" class="line_2">
                        <td>
                            <div class="input_div">
                            <span class="span">&nbsp;</span>
                                <input id="password" name="password"  autocomplete="off" tabindex="2" class="txt txt-m" type="password">
                            </div>
                        </td>
                    </tr>
					<!--
