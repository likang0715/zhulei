...
$(function() {
    $(".cata_table_li").click(function() {
		$(".cata_table_li").removeClass("desc").removeClass("asc");
...
$(function() {
    $(".tankuang_button").click(function() {
        aaa('tankuang4', 'tankuang1');
        //$(".tankuang4").hide();
        //$(".tankuang1").show();

    });
    $(".tankuang1 .tanchuang_guanbi").click(function() {
        aaa('tankuang1', 'tankuang2');

    });
    $(".tankuang2 .tanchuang_guanbi").click(function() {
        aaa('tankuang2', 'tankuang3');

    });
    $(".tankuang3 .tanchuang_guanbi").click(function() {
...
$(function() {　　
    $('.order_add_list_ul li').click(function() {　　
        $(this).toggleClass('order_curn');　　
    })　　
});


$(function() {　　
    $('.order_tongji_left span').click(function() {　　
        $(this).toggleClass('order_curn');　　
    })　　
});
//侧栏滚动
