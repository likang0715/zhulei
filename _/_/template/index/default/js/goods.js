...
$(function () {
	...
	$(".stock-change-reduce").click(function () {
        ...
        if(amout <= 2){
            $(".stock-change-reduce").removeClass('namub_down').addClass('namub_down_grey');
        }else{
            $(".stock-change-reduce").removeClass('namub_down_grey').addClass('namub_down');
        }
		if (amout <= 1) {
			return;
		}
