...
<head>
	...
	<link href="<?php echo TPL_URL;?>css/zclogin.css" type="text/css" rel="stylesheet">
	...
	<div class="header">
		<div class="header_common">
			<div class="header_inner">
				<div class="site_logo">
					<a href="<?php echo $config['site_url'];?>/zc.php"  >
						<img src="<?php echo TPL_URL;?>images/zhongchou.png" width="240" height="45">
<!--                                                <img src="<?php echo TPL_URL;?>images/zhongchou.png" width="240" height="45" alt="小猪金融">-->
					</a>
				</div>
			</div>
		</div>  
...
<div id="loginWrap" class="wrap"  style="background-image:url(<?php echo TPL_URL;?>images/zcad.jpg);">
	<div id="content" class="content">
		<div id="cent_link" class="cent_link">
			<a id="link_1" href="" style="display:block;"></a>		</div>
					...
					<tr id="line_4" class="line_4">
						<td>
							<div class="input_div">
    							...
    							<input style="background:none;padding:5px 0px;width:280px" name="phone" id="phone" autocomplete="off" tabindex="1" class="txt txt-m txt-focus cgrey2" style="font-size:12px;" placeholder="请输入手机号" type="text">
							</div>
						</td>
					</tr>
				...
				<table class="login-table">
				   ...
				   <tr id="line_1" class="line_1">
					...
					<!--
					 ...
					 <tr class="line_4" >
						<td class="cgrey2 line2" colspan="2" align="left" style="height:50px;" >
...
<!--start foot-->
   <?php include display('public:zcfooter');?>
<!--end foot-->
