	...
	<div class="activi_header_content">
					...
					<div class="index-slider ui-slider log-mod-viewed">
						...
						<div class="head ccf">
							<ul class="trigger-container ui-slider__triggers mt-slider-trigger-container">
								<?php foreach($slider as $adk => $adv) {?>
									<li class="mt-slider-trigger <?php if($adk=='0') {?>mt-slider-current-trigger<?php }?>"></li>
								<?php }?>
						...
						<ul class="content">
							...
							<li class="cf" style="opacity: 1; display: <?php if($key==0){echo 'block';}else{echo 'none';}?>;"> 
							   <a href="<?php echo $value['url'];?>"><img src="<?php echo $value['pic'];?>"></a>
							</li>
							<?php } ?>
						</ul>
					</div>
		...
		<div class="activi_header_content_right">
			...
			<div class="content_list_img activi_header_bottom">
				<a href="javascript:;" class="recommend check_activity_" data-q-start-time="<?php echo $recommend['qcode_starttime']?>" data-id="<?php echo $recommend['id'];?>">
				<img src="<?php echo $recommend['image'];?>">
				<div class="content_list_erweima">
					<div class="content_list_erweima_img "><img class="code_img" height="159" src="<?php echo $recommend['qcode']?>"  srcs1="./source/qrcode.php?type=activity&id=no&url=<?php echo $recommend['appurl'];?>"></div>
				</div>
				</a>
			</div>
		</div>
...
<div class="content activity">
	<div class="content_commodity content_activity hot_activity"  >
		...
		<div class="content_list_activity cur">
			<ul class="content_list_ul">
				...
				<li class="check_activity_" data-q-start-time="<?php echo $value['qcode_starttime']?>" data-id="<?php echo $value['id'];?>"> 
					...
					<li class="activity_list">
						<div class="content__cell content__cell--slider">
							<div class="component-index-slider1">
								<div class="index-slider ui-slider log-mod-viewed">
									<div class="pre-next"> 
										<a style="opacity: 0.6; display: block;" href="javascript:;" hidefocus="true" class="mt-slider-previous sp-slide--previous" id="hot_prev"></a> 
										<a style="opacity: 0.6; display: block;" href="javascript:;" hidefocus="true" class="mt-slider-next sp-slide--next" id="hot_next"></a> 
									</div>
									<div class="head ccf" style="display:none;">
										<ul class="trigger-container ui-slider__triggers mt-slider-trigger-container">
											<?php foreach($hot as $adk => $adv) {?>
												<li class="mt-slider-trigger <?php if($adk=='0') {?>mt-slider-current-trigger<?php }?>"></li>
											<?php }?>
											<div style="clear:both"></div>
										</ul>
		...
		<div class="content_list_activity">
			<ul class="content_list_ul">
				<?php  foreach ($hot_tuan as $key => $value) { ?>
				<li class="check_activity_" data-q-start-time="<?php echo $value['qcode_starttime']?>" data-id="<?php echo $value['id'];?>"> 
					<a href="javascript:void(0);">
					<div class="content_list_img huodong" data-json="{'name':'<?php echo $value[name]?>','type':'huodong','typename':'拼团','wx_image':'<?php echo $value['qcode']?>','cyrs':'<?php echo $value['count']?>','intro':'<?php echo $value['intro']?>'}">
						<img height="159" src="<?php echo $value['image'];?>">
						<div class="content_list_erweima">
							<div class="content_list_erweima_img"><img class="code_img" height="159" src="<?php echo $value['qcode']?>" srcs="./source/qrcode.php?type=activity&id=no&url=<?php echo $value['appurl'];?>"></div>
							<div class="content_shop_name"><?php echo $value['name'];?></div>
						</div>
					</div>
					<div class="content_list_txt">
		...
		<div class="content_list_activity">
			<ul class="content_list_ul">
				<?php  foreach ($hot_yushou as $key => $value) { ?>
				<li class="check_activity_" data-q-start-time="<?php echo $value['qcode_starttime']?>" data-id="<?php echo $value['id'];?>"> 
					<a href="javascript:void(0);">
		...
		<div class="content_list_activity">
			<ul class="content_list_ul">
				...
				<li class="check_activity_" data-q-start-time="<?php echo $value['qcode_starttime']?>" data-id="<?php echo $value['id'];?>"> 
					<a href="javascript:void(0);">
					<div class="content_list_img huodong" data-json="{'name':'<?php echo $value[name]?>','type':'huodong','typename':'限时秒杀','wx_image':'<?php echo $value['qcode']?>','cyrs':'<?php echo $value['count']?>','intro':'<?php echo $value['intro']?>'}">
						<img height="159" src="<?php echo $value['image'];?>">
						<div class="content_list_erweima">
							<div class="content_list_erweima_img"><img class="code_img" height="159" src="<?php echo $value['qcode']?>" ></div>
							<div class="content_shop_name"><?php echo $value['name'];?></div>
	...
	<div class="content_commodity content_activity nearby_activity"  >
		<div class="content_commodity_title">
			<div class="content_commodity_title_left"><a href="###"> 推荐活动</a></div>
			<div class="content_commodity_title_content">
				<ul>
					<li class="content_curn"><a href="javascript:void(0);">夺宝</a></li>
					<li><a href="javascript:void(0);">拼团</a></li>
							...
							<li class="activity_list">
								<div class="content__cell content__cell--slider">
									<div class="component-index-slider2">
										<div class="index-slider ui-slider log-mod-viewed">
											<div class="pre-next"> <a style="opacity: 0.6; display: block;" href="javascript:;" hidefocus="true" class="mt-slider-previous sp-slide--previous " id="fj_prev"></a> <a style="opacity: 0.6; display: block;" href="javascript:;" hidefocus="true" class="mt-slider-next sp-slide--next" id="fj_next"></a> </div>
											<div class="head ccf" style="display:none;">
												<ul class="trigger-container ui-slider__triggers mt-slider-trigger-container">
													<?php foreach($nearby as $adk => $adv) {?>
														<li class="mt-slider-trigger <?php if($adk=='0') {?>mt-slider-current-trigger<?php }?>"></li>
													<?php }?>
													<div style="clear:both"></div>
												</ul>
