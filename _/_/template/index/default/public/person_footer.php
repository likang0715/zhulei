...
//延迟加载图片
	...
	function showRequest() {
		...
		if(_act == "point_log"){
			...
			var stime = '<?php echo  $_GET['stime']?>';
			var etime = '<?php echo  $_GET['etime']?>';
			var dosearch = '<?php echo  $_GET['dosearch']?>';
			if(dosearch){
				location.href = "<?php echo url('account:point_log') ?>&order_no=" + order_no+"&type=" + type+"&stime=" + stime+"&etime=" + etime+"&dosearch=" + dosearch+"&page=" + page;
			}else{
