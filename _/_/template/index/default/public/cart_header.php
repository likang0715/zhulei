        ...
        <div class="sn-container">
            ...
            <ul class="sn-quick-menu">
                ...
                <li class="sn-mytaobao menu-item j_MyTaobao">
                    <div class="sn-menu">
                        <a rel="nofollow" target="_top" href="<?php echo url('account:index') ?>" class="menu-hd"aria-haspopup="menu-2" aria-label="右键弹出菜单，tab键导航，esc关闭当前菜单">我的账户<b></b></a>
            ...
            <div class="cart-header">
                ...
                <div class="cart-line">
                    ...
                    <ul class="order-header order-cart-header">
                        <li <?php if($step=='one') {?>class="order-current-step"<?php }?>>
                            <span class="order-step">1</span>
                            <p class="order-step-text">购物车</p>
                            <p class="order-step-time"></p>
                        </li>
                        <li <?php if($step=='two') {?>class="order-current-step"<?php }?>>
                            <span class="order-step">2</span>
                            <p class="order-step-text">确认收货地址信息</p>
                            <p class="order-step-time"></p>
                        </li>
                        <li <?php if($step=='three') {?>class="order-current-step"<?php }?>>
