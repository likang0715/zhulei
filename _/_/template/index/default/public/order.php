...
<div class="menudiv">
				...
				?>
                    <div class="order_list">
                        <div class="order_list_title"> <span class="mr20">订单编号：<a href="###"><?php echo option('config.orderid_prefix') . $order['order_no'] ?></a> </span><span>预订时间：<?php echo date('Y-m-d H:i:s', $order['add_time']) ?></span> </div>
						<?php if(count($order['product_list'])>1){ ?>
						...
						?>
                            ...
                            <dd><div class="order_list_img"><img src="<?php echo $product['image'] ?>"></div>
                        ...
                        <ul class="order_list_list" style="border-bottom:0;">
                            <li class="head_1">
                                ...
                                <div class="order_list_txt"> <a href="<?php echo url_rewrite('goods:index', array('id' => $product['product_id'])) ?>" target="_blank">
                                    <?php echo htmlspecialchars($product['name']) ?></a></div>
                            </li>
                            <li class="head_2"> <?php echo $product['pro_price'] ?> </li>
                            <li class="head_3"><?php echo $product['pro_num'] ?></li>
                            <li class="head_4"><?php 
