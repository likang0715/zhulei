									...
									<div class="shop_list">
										<form onsubmit="return false">
											<div class="shop_guanzhu">
												<button data-id="<?php echo $product['product_id'] ?>" onclick="javascript:userAttention(<?php echo $product['product_id'] ?>, 1,<?php echo $product['store_id']?>)">关注商品</button>
											</div>
											<div class="shop_shoucang ">
												<button data-id="<?php echo $product['product_id'] ?>" onclick="javascript:userCollect(<?php echo $product['product_id'] ?>, 1,<?php echo $product['store_id']?>)">收藏商品</button>
											</div>
										</form>
									</div>
								</div>
