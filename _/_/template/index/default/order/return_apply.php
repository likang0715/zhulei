...
<title>退货申请-<?php echo $config[ 'site_name'];?></title>
...
<div class="order_content ">
	<div class="Breadcrumbs"> 您的位置：<a href="/">首页</a> &gt; <a href="<?php echo url('account:index') ?>">会员中心</a> &gt; <a href="<?php echo url('account:return_order') ?>" class="current">退货申请</a> </div>
	...
	<div class="order_order order_gengzong">
		<div class="order_add_titele ">退货说明</div>
		<div  class="order_gengzong_list">
			<div class="order_gengzong_select clearfix">
				<div class="order_gengzong_txt">退货理由:</div>
			...
			<div class="order_gengzong_select clearfix">
				...
				<input style="border: 1px solid #2ecc9e; margin:0 15px; width:220px; height:32px;" id="phone" placeholder="请填写手机号方便卖家与您联系" />
			</div>
			<div class="order_gengzong_select clearfix">
				<div class="order_gengzong_txt">退货原因:</div>
				<textarea style="border: 1px solid #2ecc9e; margin:0 15px; width:400px; height:80px;" id="content" placeholder="请填写退货原因"></textarea>
			</div>
			<div class="order_gengzong_select clearfix">
				<div class="order_gengzong_txt">退货数量:</div>
				<select name="pro_num">
					<?php 
			...
			<div class="order_gengzong_select clearfix">
				<div class="order_gengzong_txt">退货图片: 最多可上传5张</div>
