...
<div class="order_content">
	...
	<div class="zhifu_content">
		...
		<?php 
		if ($order['payment_method'] != 'codpay' && $order['payment_method'] != 'peerpay') {
		?>
			<div class="pay-code">
				<h1>扫码支付</h1>
				<ul class="pay-code-list">
					<li class="code">
						<img  src="<?php echo STATIC_URL;?>images/blank.gif"class="qrcode_img">
						<div class="txt">
							微信扫一扫<br>
							轻松完成支付
						</div>
		...
		?>
			<div class="pay-code">
				...
				<ul class="pay-code-list">
					<li class="code">
						<img src="<?php echo $config['site_url'];?>/source/qrcode.php?type=peerpay&id=<?php echo $order['order_no_txt'] ?>" class="qrcode_img">
						<div class="txt">
							微信扫一扫<br>
							轻松完成支付或分享给你朋友，让他们代付
						</div>
