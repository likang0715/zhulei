...
<head>
	<meta charset="UTF-8">
	<title>我的商家做单列表-<?php echo option('config.site_name') ?></title>
	...
	<script src="<?php echo TPL_URL;?>js/store_offline_list.js"></script>
	<script src="<?php echo TPL_URL;?>js/base.js"></script>
</head>
<body>
<ul class="nav managenav js-nav_list">
	<li class="nav-active fl navli">我的商家做单</li>
	<li class="fl navli js-my_order">我的做单</li>
	<!--！！！！！！！！！！！！-->
