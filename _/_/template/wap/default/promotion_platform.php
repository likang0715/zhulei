...
<div class="hbPage">
    <div class="row">
        <div class="cellRow addBorder">
            <h2 style="text-align: center;font-weight:bold;">平台推广名片</h2>
        </div>
        <div class="cellRow addBorder">
            <span class="nameSpan">我的昵称</span><span class="nameDesc"><?php echo $user_info['nickname'];?></span>
        </div>
        <div class="cellRow">
            <span class="nameSpan">推广对象</span><span class="nameDesc"><?php echo $promote_array['name'] ;?></span>
        </div>
    </div>
    <div class="row">
        <div class="hd">
    ...
    <div class="row">
        ...
        <div class="hbImg">
            <?php if($promote['poster_type'] == 1) {?>
                <img src="<?php echo trim(STATIC_URL,'/static');?>/template/wap/default/img/1.png" width="250" height="210"/>
            <?php } elseif ($promote['poster_type'] == 2) {?>
                <img src="<?php echo trim(STATIC_URL,'/static');?>/template/wap/default/img/2.png" width="200" height="270"/>
            <?php } elseif ($promote['poster_type'] == 3) {?>
                <img src="<?php echo trim(STATIC_URL,'/static');?>/template/wap/default/img/3.png" width="250" height="250"/>
            <?php }?>
        </div>
    </div>
    <div class="hbBtn">
        <ul>
            ...
            <li>
                <a href="javascript:;" class="down">获取平台名片</a>
            </li>
        </ul>
    </div>
    ...
    <script>
        $('.down').click(function(){
            ...
            $.post('./promotion_platform.php',{'act':act},function(data){
                layer.close(loadi);
