				...
				<div class="paid-status success">
					<?php if($nowOrder['status'] == 1){ ?>
						...
						<div class="body block block-list">
							...
							<div class="block-item">
								<ul class="block block-form block-border-none">
									<li class="block-item">
										<label>付款金额：</label>
										<span class="price">￥<?php echo $nowOrder['money']?></span>
									</li>
									<li class="block-item">
										<label>订单编号：</label>
						...
						<div class="action-container">
							...
							<a class="btn btn-block " href="./order.php?orderid=SMSPAY_<?php echo $nowOrder['sms_order_id'];?>">查看订单详情</a>
						</div>
					<?php }else{ ?>
						<div class="header center">
