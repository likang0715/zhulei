...
<head>
    ...
    <title>分销订单 - <?php echo $store['name']; ?></title>
    ...
    <script type="text/javascript">
        ...
        var PAGESIZE = 10;
        var MaxPage = 0;
        var MaxPage_1 = Math.ceil(parseInt('<?php echo $uncomplated_orders; ?>') / PAGESIZE);
        var MaxPage_2 = Math.ceil(parseInt('<?php echo $complated_orders; ?>') / PAGESIZE);
...
<div class="fixed">
	...
	<?php if($_COOKIE['wap_store_id']) {?>
		<a class="menu-icon" href="./ucenter.php?id=<?php echo $_COOKIE['wap_store_id'];?>#promotion" onclicks="javascript:history.go(-1);"><span></span></a>
	<?php } else {?>
		<a class="menu-icon" href="javascript:void(0)" onclicks="javascript:history.go(-1);"><span></span></a>
	<?php }?>			
...
<dl id="tabs_dl" class="tabs tab-title3" data-tab="">
    <dd class="active" data-status="1"><a href="javascript:void(0)">未分佣(<?php echo $uncomplated_orders; ?>)</a></dd>
    <dd data-status="2"><a href="javascript:void(0)">已分佣(<?php echo $complated_orders; ?>)</a></dd>
</dl>
<div class="tabs-content" id="wrapper">
    <div id="scroller" class="content active">
        ...
        <div class="nocontent-tip" id="ordernull" style="">
            ...
            <p class="nocontent-tip-text">您还没有订单</p>
        </div>
