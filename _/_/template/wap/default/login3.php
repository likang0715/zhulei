...
<html class="no-js" lang="zh-CN">
	<head>
		...
		<script>var redirect_uri="<?php echo $redirect_uri;?>";var is_open_sms = "<?php echo $is_used_sms;?>"</script>
		<script src="<?php echo TPL_URL;?>js/base.js"></script>
		<!--<script src="<?php echo TPL_URL;?>js/login3.js"></script>-->
		<script src="/template/wap/default/js/login3.js"></script>
	</head>
	<body>
		<!-- container -->
		<div class="container js-modal-login">
            <div class="account-form login-form">
				<form class="js-login-form " method="POST" action="/wap/login3.php" referer="<?php echo $redirect_uri;?>">
					<h2 class="js-login-title form-title big">
						<span>请先登录账号</span>
					</h2>
					<!-- 表单主体 -->
					<input type="hidden" name="referer" value="<?php echo $redirect_uri;?>"/>
					<ul class="block block-form margin-bottom-normal">
						...
						<li class="block-item" style="margin-bottom: -1px">
							...
							<input id="password" type="password" name="pwd" autocomplete="off" class="js-login-pwd" placeholder="请填写您的密码">
						</li>
					</ul>
