...
if (void 0 == APP_API_URL) var APP_API_URL = /localhost/.test(location.host) ? "http://localhost:63342/": "http://www.pigcms.com//";
if (void 0 == APP_LIST_URL) var APP_LIST_URL = "";
if (void 0 == APP_FOLLOW_URL) var APP_FOLLOW_URL = "<?php echo './yousetdiscount.php?action=index&store_id='.$info['store_id'].'&id='.$info['id'].'&share_key='.$share_key; ?>";
