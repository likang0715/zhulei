...
'cookie_pre' => 'nZXtD_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程

'js_path' => 'http://longfeiye.com/statics/js/', //CDN JS
'css_path' => 'http://longfeiye.com/statics/css/', //CDN CSS
'img_path' => 'http://longfeiye.com/statics/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => 'http://longfeiye.com/',//动态域名配置地址
...
'errorlog' => 0, //是否保存错误日志
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'C7lSbVianlZg9cWrnEUl', // //Cookie密钥
'lang' => 'zh-cn',  //网站语言包
'admin_founders' => '1', //网站创始人ID，多个ID逗号分隔
'execution_sql' => 0, //EXECUTION_SQL
//UCenter配置开始
'ucuse'=>'0',//是否开启UC
'uc_api'=>'http://longfeiye.com/comsenz/uc',//Ucenter api 地址
