...
<div class="personal-complete">
    ...
    <div class="personal-center" id="divInfo">
        <ul class="side-nav" id="list" style="margin-top:0;">
            <div class="row">
                <h3>团队Logo</h3>
                <form enctype="multipart/form-data" id="upload_image_form" method="post" action="comment_attachment.php">
                    <div class="setInfo">
                        <div class="fl userAvatar">
                            ...
                            <input class="addFile" name="file" type="file" id="upload_image"/>
                        </div>
                        <div class="textInfo">
                            点击左边的图片修改logo
                            建议尺寸，200*200像素，小于120kb，
                            支持jpg，gif，png格式
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function showResponseUpload(data) {
        var post_url = './team_info.php?action=upload';
