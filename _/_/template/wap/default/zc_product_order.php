				...
				<div class="app app-order">
					<div class="app-inner inner-order" id="js-page-content">
						...
						<div class="block block-order block-border-top-none" data-id="<?php echo $nowOrder['order_id']; ?>" data-float-amount="<?php echo $nowOrder['float_amount']; ?>">
							...
							<hr class="margin-0 left-10"/>
							<div class="bottom">支付金额<span class="c-orange pull-right">￥<?php echo $nowOrder['pay_money']-$nowOrder['freight'];?></span></div>
							<div class="bottom">运费<span class="c-orange pull-right">￥<?php echo $nowOrder['freight'];?></span></div>

						</div>
						<!-- 物流 -->
						<!-- 支付 -->
						<div class="js-step-topay <?php if($nowOrder['sms_total'] == '0.00' && $nowOrder['order_status']==0){ ?>hide<?php }?>">
