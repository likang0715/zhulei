...
<html lang="zh-CN">
	<head>
		...
		<script>
		var domain = '<?php echo $domain;?>',keyword = '<?php echo $keyword;?>';
		</script>
		<script src="<?php echo TPL_URL;?>index_style/js/near_weidian_search.js"></script>
	</head>
	<body style="background:#efefef;">
		...
		<div class="wx_wrap wei_v2">
			<div class="wei_tab_box" id="divTabList">
				<div class="mod_fix">
					<div class="wei_tab">
						<a id="aRecommendShopBtn" href="./nearweidian.php?domain=<?php echo urlencode($domain);?>">身边的微店</a>
						<a id="aFollowShopBtn" class="cur" href="javascript:;">搜索微店</a>
					</div>
				</div>
			</div>
