						...
						<div class="sidebar-section qrcode-info">
							<div class="section-detail">
								...
								<p class="text-center qr-code">
									<img width="158" height="158" src="<?php echo $config['site_url'];?>/source/qrcode.php?type=good_cat&id=<?php echo $nowGroup['group_id'];?>&store_id=<?php echo $now_store['store_id']; ?>">
								</p>
							</div>
						</div>
					</div>
