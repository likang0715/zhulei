...
<head>
	...
	<script>var buytype="presale", storeId=<?php echo $now_store['store_id'];?>,product_id=<?php echo $nowProduct['product_id'];?>,showBuy=!!<?php echo intval($_GET['buy'])?>,hasActivity=!!<?php echo intval($nowActivity);?>,activityId=<?php echo intval($nowActivity['pigcms_id']);?>,activityType=<?php echo intval($nowActivity['type']);?>,activityDiscount=<?php echo floatval($nowActivity['discount']);?>,activityPrice=<?php echo floatval($nowActivity['price']);?>;</script>
...
<body <?php if($is_mobile){ ?> class="body-fixed-bottom" <?php } ?>>
		...
		<div class="header">
			...
			<div class="js-mp-info share-mp-info">
				...
				<div class="links">
					<a class="mp-homepage"
						href="<?php echo $now_store['ucenter_url'];?>">会员中心</a>
				</div>
			...
			<div class="content-body">
					...
					<div class="swiper-container" style="height: 320px;">
						<div class="swiper-wrapper">
								...
								<a class="js-no-follow" href="javascript:;" style="height: 320px;"> <img src="<?php echo $value['image'];?>" />
								</a>
							</div>
								<?php } ?>
							</div>
						...
						<div class="div_nav" id="div_nav">
							<ul class="box"><!--
								...
								<li style="border-right: 1px solid #ced3d7;">
									<a href="javascript:;"  class="goods_guanzhu">关注（<span><?php echo count($self_attention_goods_num); ?></span>）</a>
								</li>
								<li>
									<a href="javascript:;" class="goods_shoucang">收藏（<span><?php echo  count($self_collect_goods_num);; ?></span>）</a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="div_sections" id="div_sections">
						...
						<section class="section_comments section_section" data-type="default">
							...
							<div class="sub_comment">
								<a href="./comment_add.php?type=PRODUCT&id=<?php echo $nowProduct['product_id'];?>" class="btn-block">发表评价</a>
							</div>
							-->
							<?php } ?>
							<div>
								<div class="tabber tabber_menu tabber-ios clearfix js-comment-tab">
									<a class="active"  data-tab="0">好评</a>
									<a class="c_middle" data-tab="1">中评</a>
									<a data-tab="2">差评</a>
								</div>
							</div>
							<div id="list_comments">
								<ul class="list_comments on" id="list_comments_0" data-page="1" data-type="default" next="true"></ul>
								<ul class="list_comments" id="list_comments_1" data-page="1" data-type="default" next="true"></ul>
								<ul class="list_comments" id="list_comments_2"  data-page="1" data-type="default" next="true"><div class="s_empty" id="noMoreTips">已无更多评价！</div></ul>
							...
							<div class="section-detail">
								...
								<p class="text-center qr-code">
									<img width="158" height="158"
										src="<?php echo $config['site_url'];?>/source/qrcode.php?type=good&id=<?php echo $nowProduct['product_id'];?>&store_id=<?php echo $now_store['store_id']; ?>">
								</p>
							</div>
						</div>
					</div>
