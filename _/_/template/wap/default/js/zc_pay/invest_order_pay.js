...
$(function(){
	...
	$('#confirm-pay-way-opts .btn-pay').click(function(){
		...
		var post_data = {payType:payType,zcpay_no:zcpay_no,msg:'','total':$("#js-total").html()};
		if($('#address_id').size() > 0){
...
*/
		...
		$.post('zc_pay_order.php?action=pay',post_data,function(result){
