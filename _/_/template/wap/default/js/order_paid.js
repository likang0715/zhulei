$(function(){
	...
	$('.btn-complate').live('click', function(e) {
		...
		$.get(complate_url, "", function(data){
			if (data.err_code != 0) {
				...
				motify.log(data.err_msg, 0);
				window.location.href='my_order.php?action=complete';
			}
		});
	});
	...
	$(".express-context a").click(function () {
		...
		if ($(this).closest("div").find(".express_detail").data("is_has") == "0") {
			...
			var url = "express.php?type=" + type + "&order_no=" + order_no + "&express_no=" + express_no;
	...
	$(".js-order_end").click(function () {
		var order_id = $(this).data("order_id");
		
		$.post("./presale_saveorder.php?action=endpay", {"order_id":order_id}, function (result) {
