$(function() {
	...
	var url = "my_offline_list.php?store_id=" + store_id;
	getOrder();
	
	$(".js-user_offline").click(function () {
		location.href = "user_order_offline_list.php?store_id=" + $(this).data("store_id");
	});
	...
	$(".js-order_complate").live("click", function () {
		...
		var obj = $(this);
		$.post("order_ajax.php?action=complate&store_id=" + store_id, {order_id: order_id}, function (result) {
