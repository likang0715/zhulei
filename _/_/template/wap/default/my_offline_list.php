...
<head>
	<meta charset="UTF-8">
	<title>商家做单列表-<?php echo htmlspecialchars($store['name']) ?>-<?php echo option('config.site_name') ?></title>
	...
	<script src="<?php echo TPL_URL;?>js/my_offline_list.js"></script>
	<script src="<?php echo TPL_URL;?>js/base.js"></script>
</head>
<body>
<ul class="nav managenav js-nav_list">
	<li class="nav-active fl navli">商家做单管理</li>
	<li class="fl navli js-user_offline" data-store_id="<?php echo $store_id ?>">用户做单管理</li>
	<!--！！！！！！！！！！！！-->
	...
	<li class="fl navshop navli js-status_list"><b class="txt" style="font-weight: normal;">订单状态</b><span class="navicon icon-caret-up"></span>
		<div class="nav-son" style="display: none;">
			...
			<div class="nav-son-con managenav-con" data-status="0">
				...
				<div data-status="1" class="js-status">未审核</div>
				<div data-status="2" class="js-status">通过未发放</div>
				<div data-status="3" class="js-status">通过已发放</div>
				<div data-status="4" class="js-status">审核不通过</div>
			</div>
		</div>
	</li>
</ul>
...
<?php Analytics($store['store_id'], 'my_offline_list', '店铺做单', $store['store_id']); ?>