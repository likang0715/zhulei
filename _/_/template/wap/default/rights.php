	...
	<head>
		...
		$(function () {
			...
			$("#pages a").click(function () {
				...
				location.href = "rights.php?id=<?php echo $store_id ?>&page=" + page;
			});
	...
	<body>
		<div class="container">
			<div class="tabber tabber-n2 tabber-double-11 clearfix" style="margin-bottom:5px;position:fixed;top:0px;height:40px;z-index:900">
				<a href="./return.php?id=<?php echo $store_id;?>">退货</a>
				<a class="active" href="./rights.php?id=<?php echo $store_id;?>">维权</a>
			</div>
			<div class="content">
