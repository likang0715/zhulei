	...
	$.ajax({
		...
		success:function(result){console.log(result)
			...
			if(result.err_code){
				...
				$('.wx_wrap,#yScroll1,#yScroll2,#category2,.swiper-container,.swiper-container2,#allcontent').height($(window).height()-$('.WX_search').height()-110);
				$('#yScroll2').width($(window).width()-125);
