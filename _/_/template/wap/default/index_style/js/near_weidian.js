...
function arroundErrorTips(msg){
	$('#divEmptyFollow').show().css('padding-top','8px');
...
function get_near_shops(){
	$.post('./index_ajax.php?action=butt_nearshops',{'domain':domain,'long':user_long,'lat':user_lat},function(result){
		if(result.err_code){
