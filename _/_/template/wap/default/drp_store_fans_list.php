        ...
        <?php if ($fans_count > 0) {?>
            <div id="dataArea">
                <table width="100%">
                    <thead>
                    <tr>
                        <th style="text-align: left">粉丝名称</th>
...
<tbody>
					...
					<tr>
                        <td style="text-align: left"><?php echo $user_list[$v['user_id']]['nickname']; ?></td>
                        <td style="text-align: center"><?php echo date('Y-m-d H:i:s',$v['add_time']);?></td>
						<!--<td style="text-align: left"><?php echo $v['open_id']?'关注店铺':'访问店铺'?></td>-->
                    </tr>
					<?php }?>
                    </tbody>
                </table>
