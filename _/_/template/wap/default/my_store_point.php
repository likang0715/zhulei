...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta charset="utf-8">
		<title>我的店铺<?php echo $point_alias; ?></title>
		...
		<script>var page_url = 'my_point.php?action=store_point&store_id=<?php echo $store['store_id']; ?>&ajax=1', page_type = '<?php echo $action;?>', label = '店铺';</script>
	...
	<body>
		<div class="promote">
			<div class="hd">
				<ul class="flex">
					<li class="on">
						<a href="./my_point.php?action=store_point&store_id=<?php echo $store['store_id']; ?>">商家积分流水<!-- <?php echo $point_alias; ?> --></a>
					</li>
					<!-- <li>
