...
<div class="row count">
    ...
    <div class="small-4 large-3 columns mid">
        <a href="./drp_commission.php?a=statistics" class="count-a">
            ...
            <span class="count-title">佣金总额(元)</span>
        </a>
    </div>
</div>
        ...
        <li>
            ...
            <div id="disstroe-sub" class="member-nav-sub">
                <ul class="member-nav-sub-ul">
                    ...
                    <li class="member-nav-sub-li"><a href="./drp_store.php?level=<?php echo $key; ?>"><span class="text"><?php echo $value; ?>级分销</span><i class="arrow"></i></a></li>
                    <?php } ?>
                </ul>
            </div>
        </li>
        <?php } ?>
        <li id="drpProduct"><a href="./drp_products.php?a=index"><i class="icon-product"></i><span class="text">分销商品</span><i class="arrow"></i></a></li>
        <li id="drpOrder"><a href="./drp_order.php?a=index"><i class="icon-disorder"></i><span class="text">分销订单</span><i class="arrow"></i></a></li>
    </ul>
</div>
