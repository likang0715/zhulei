			...
			<form method="post" action="" enctype="multipart/form-data">
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					...
					<tr class="class_1" <?php if($first['type'] != 1): ?>style="display:none"<?php endif; ?>>
						...
						<td>
							<input type="text" class="input-text" name="url" id="url" value="<?php echo ($first["url"]); ?>" style="width:200px;" placeholder="外链接url如：http://www.baidu.com" validate="maxlength:200,url:true" tips="外链接url如：http://www.baidu.com"/>
							<!-- <a href="#modal-table" class="btn btn-sm btn-success" onclick="addLink('url',0)" data-toggle="modal">从功能库选择</a> -->
						</td>
					</tr>
					<tr class="class_1" <?php if($first['type'] != 1): ?>style="display:none"<?php endif; ?>>
						<th width="160">回复图片　</th>
						<td><input type="file" class="input-text" name="pic" id="pic" value=""/></td>
					</tr>
