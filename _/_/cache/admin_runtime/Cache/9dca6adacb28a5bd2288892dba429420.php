					...
					<table width="100%" cellspacing="0">
						...
						<tbody>
							<?php if(is_array($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$store): $mod = ($i % 2 );++$i;?><tr>
										<td><?php echo ($store["orderid"]); ?></td>
                                        <td><?php echo ($store["tablename"]); ?></td>
										<td><?php echo ($store["p_name"]); ?></td>
										<td><?php echo ($store["name"]); ?></td>
										<td><?php echo ($store["phone"]); ?></td>
										<td><?php echo ($store["dd_time"]); ?></td>
										<td><?php echo ($store["sc"]); ?></td>
										<td><?php echo (date('Y-m-d H:i:s', $store["dateline"])); ?></td>
