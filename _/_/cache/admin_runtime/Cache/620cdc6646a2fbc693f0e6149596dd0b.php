...
> 
	<form id="myform" method="post" action="<?php echo U('Tag/add');?>" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
					<select name="property_type_id" class="property_type" tips="">
						...
						<?php if(is_array($system_property_type_list)): foreach($system_property_type_list as $k=>$propertytype): ?><option value="<?php echo ($propertytype["type_id"]); ?>" <?php if($propertytype['type_id'] == $category['type_id']): ?>selected<?php endif; ?>><?php echo ($propertytype["type_name"]); ?></option><?php endforeach; endif; ?>
					</select>
				</td>
			</tr>
			<tr>
