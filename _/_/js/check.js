...
$(function() {
    ...
    if (getQueryString('type_check')) {
        type_check = getQueryString('type_check');
    }
	
    load_page('.app__content', load_url, {page: page_content, 'type_check':type_check,'status': tmp_status, 'start_time': start_time, 'stop_time': stop_time, 'time_type': time_type}, '', function(){
        if (start_time) {
