 ...
 */
$(function() {
    load_page('.app__content', load_url, {page:'statistics_content'}, '');
    ...
    $('.js-filter-btn').live('click', function(){
        ...
        load_page('.app__content', load_url, {page:'statistics_content', 'start_time': start_time, 'stop_time': stop_time}, '', function(){
