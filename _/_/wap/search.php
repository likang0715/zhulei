...
if($cat_id) {
	$cat_info = D('Product_category')->where(array('cat_id'=>$cat_id))->find();
}
...
//商品搜索
$goodList = M('Product')->getSearchGroupGoodList($key,$page,$tmp_store_id, $store_id, $now_store['drp_level'], $now_store['drp_diy_store'],$cat_id);
