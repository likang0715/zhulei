...
class jpush {
	...
	function __construct() {
		$this->_masterSecret = 'd3fd7b1a89423b6fd0aa0236';
		$this->_appkeys = '7f03c038a2a048304b3d064d';
	    $this->_smasterSecret = 'd3fd7b1a89423b6fd0aa0236';
		$this->_sappkeys = '7f03c038a2a048304b3d064d';
	}
	/**
	 * 模拟post进行url请求
	 * @param string $url
	 ...
	 */
	function send($sendno = 0,$receiver_type = 1, $receiver_value = '', $msg_type = 1, $msg_content = '', $platform = 'android', $supplier = '1') {
		...
		$appkeys = $this->_sappkeys;	
		$masterSecret = $this->_smasterSecret;	
		}		
