	...
	<script type="text/javascript">
		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					<a href="{pigcms{:U('Product/comment')}" class="on">商品评论列表</a>
				</ul>
			</div>
			<table class="search_table" width="100%">
				<tr>
					<td>
						<form action="{pigcms{:U('Product/comment')}" method="get">
							...
							<if condition="is_array($comments)">
								<volist name="comments[comment_list]" id="comment" key ="k">
									...
									<tr>
										...
										<else/> 
										 <td class="first_td">
										 	<a url="<?php echo U('Product/comment_del', array('comment_id' => $comment['id'],'delete'=>1)); ?>"  class="delete_row"><img src="{pigcms{$static_path}images/icon_delete.png" width="18" title="删除" alt="删除" /></a> 
										 </td>										 
										</if> 
										<td>
