<include file="Public:header"/>
	...
	<form id="myform" method="post" action="{pigcms{:U('Sys_product_property/property_edit')}" enctype="multipart/form-data">
		...
		<div class="btn hidden">
			...
			<input type="hidden" name="type_id" value="{pigcms{$property.type_id}" />
