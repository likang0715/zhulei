<include file="Public:header"/>
	...
	<form id="myform" method="post" action="{pigcms{:U('Sys_product_property/property_add')}" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
                <th width="80">所属商品类型</th>
                <td>
	                <select name="property_type_id" class="property_type" validate="required:true" tips="">
			...
			<tr>
				<th width="80">分类排序</th>
				<td><input type="text" class="input fl" name="sort" value="0" size="10" placeholder="分类排序" validate="maxlength:6,number:true" tips="默认添加id排序！手动排序数值越小，排序越前。"/></td>
			</tr>
