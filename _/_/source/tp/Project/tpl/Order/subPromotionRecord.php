...
<div class="mainbox">
    <div id="nav" class="mainnav_title">
        <ul>
            <a href="{pigcms{:U('Order/subPromotionRecord', ['admin_type'=>0])}" class="<?php if ($admin_type == 0) { echo 'on'; } ?>">下属区域管理员</a>
            <a href="{pigcms{:U('Order/subPromotionRecord', ['admin_type'=>1])}" class="<?php if ($admin_type != 0) { echo 'on'; } ?>">下属代理商管理员</a>
        </ul>
    </div>
        ...
        <tr>
            <td>
                <form action="{pigcms{:U('Order/myPromotionRecord')}" method="get">
                    ...
                    <input type="hidden" name="a" value="subPromotionRecord"/>
