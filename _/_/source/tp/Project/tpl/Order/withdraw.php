...
<div class="ui-box">
    <table class="ui-table ui-table-list" style="padding: 0px;">
        ...
        <tr class="widget-list-header">
            ...
            <th class="cell-12 text-right">平台服务费</th>
            <th class="cell-12 text-right">实际提现金额(元)</th>
            <th class="cell-12">处理完成时间</th>
            <th class="cell-12" style="width: 50px;">状态</th>
        ...
        <tr class="widget-list-item">
            ...
            <td class="text-right">{pigcms{$withdrawal.sales_ratio}%</td>
            <td class="text-right ui-money-income">{pigcms{$withdrawal.real_amount}</td>
