...
-->
	...
	<form id="myform" method="post" action="{pigcms{:U('Physical/chcate_add')}" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">分类图片</th>
				<td><input type="file" class="input fl" name="pic" style="width:175px;" validate="required:true"  placeholder="请上传图片" tips="二级分类建议上传！用于网站的商品分类列表。"/></td>
			</tr>
					
			<tr>
				<th width="80">分类排序</th>
				<td><input type="text" class="input fl" name="cat_sort" value="0" size="10" placeholder="分类排序" validate="maxlength:6,number:true" tips="默认添加id排序！手动排序数值越小，排序越前。"/></td>
			</tr>
