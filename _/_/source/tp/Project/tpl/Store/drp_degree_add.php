...
$(function(){
	...
	<form id="myform" method="post" action="{pigcms{:U('Store/drp_degree_add')}" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">条件积分</th>
				<td>
					<input  type="text" class="input fl" name="condition_point"  validate="required:true,maxlength:6,number:true">

				</td>
			</tr>
			<tr>
				<th width="80">等级值</th>
				<td><input type="text" class="input fl" name="value" value="0" size="10" placeholder="等级值" validate="required:true,maxlength:6,number:true" tips="等级值越大，将越靠前显示！。"/></td>
			</tr>
