...
<div class="mainbox">
    ...
    <div class="nav_div">
        <a href="{pigcms{:U('Indiana/adver')}" class="">PC端广告</a>
        <a href="{pigcms{:U('Indiana/wap_adver')}" class="active">移动端广告</a>
        <p>唯一区别:图片显示大小不一样</p>
    </div>
    <div id="nav" class="mainnav_title">
        <ul>
            <a href="{pigcms{:U('Indiana/wap_adver')}" class="on">手机端-首页幻灯片(320*120)-广告列表</a>|
            <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Indiana/adver_add',array('type'=>2))}','添加移动端首页幻灯片(320*120)',600,190,true,false,false,addbtn,'add',true);">添加广告</a>
        </ul>
    </div>
