...
<style>
	...
	<form id="myform" method="post" action="{pigcms{:U('Product_property/property_add')}" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<td>
					<font class="green">启用</font>	<br/>（<font class="red">*注：用户购买的商品属性，商家中心不可修改或添加该值</font>）
				</td>
