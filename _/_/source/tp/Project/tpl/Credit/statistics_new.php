<include file="Public:header"/>
    ...
    <div id="nav" class="mainnav_title">
        <ul>
            ...
            |
            <a href="{pigcms{:U('Credit/statistics_new')}" class="on" >积分统计数据汇总</a>
        </ul>
    </div>

	<table cellpadding="0" cellspacing="0"  width="100%" class="frame_form" >
        <tr>
        <th width="300">1.累计从消费积分释放的【可用积分】总数：</th>
        <td>{pigcms{$release_point|default="0"}</td>
        </tr>
        <tr>
        <th width="300">2.累计已释放消费积分耗损总数：</th>
        ...
        <tr>
        <th width="300">4.累计【可用积分】总数：</th>
        <td>{pigcms{$balance_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">5.累计消耗可用积分：</th>
        <td>{pigcms{$lose_user_balance|default="0"}</td>
        </tr>
        <tr>
        <th width="300">6.累计商家用于【补单】的可用积分总数：</th>
        <td>{pigcms{$store_offline_balance|default="0"}</td>
        </tr>
        <tr>
        <th width="300">7.累计（兑换商品）转为【商家积分】的可用积分总数：</th>
        <td>{pigcms{$change_user_point_balance_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">8.累计可用积分总余额：</th>
        <td>{pigcms{$user_balance_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">9.累计可用积分兑换商品转为商家积分火耗：</th>
        <td>{pigcms{$deplete_point_balance_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">10.累计商家积分总数：</th>
        <td>{pigcms{$store_point_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">11.累计商家积分总余额：</th>
        <td>{pigcms{$store_point_balance_total|default="0"}</td>
        </tr>
        <tr>
        <th width="300">12.累计消耗的商家积分：</th>
        <td>{pigcms{$deplete_store_points|default="0"}</td>
        </tr>
        <tr>
        ...
        <tr>
        <th width="300">16.累计转兑现现金火耗：</th>
        <td>{pigcms{$store_point2money_service_fee|default="0"}</td>
        </tr>
        <tr>
        <th width="300">17.累计已转可兑现现金总额：</th>
        <td>{pigcms{$store_withdrawal|default="0"}</td>
        </tr>
        <tr>
        <th width="300">18.累计商家可兑现现金账总余额：</th>
        ...
        <td>{pigcms{$evaluate_today_release_send_point|default="0"}</td>
        </tr>
        <tr>
        ...
        <tr>
        <th width="300">F.累计赠送积分总数(不包含积分做单赠送的消费积分部分)：</th>
        ...
        <td>{pigcms{$yes_margin_back|default="0"}</td>
        </tr>
        <tr>
        ...
        <td>{pigcms{$common_data[1]['value']|default="0"}</td>
        </tr>
        <tr>
        ...
        <td>{pigcms{$cash_provision_balance_now|default="0"}</td>
        </tr>
        <tr>
