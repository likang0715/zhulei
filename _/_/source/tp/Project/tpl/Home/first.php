			...
			<form method="post" action="" enctype="multipart/form-data">
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					...
					<tr class="class_1" <if condition="$first['type'] neq 1">style="display:none"</if>>
						...
						<td>
							<input type="text" class="input-text" name="url" id="url" value="{pigcms{$first.url}" style="width:200px;" placeholder="外链接url如：http://www.baidu.com" validate="maxlength:200,url:true" tips="外链接url如：http://www.baidu.com"/>
