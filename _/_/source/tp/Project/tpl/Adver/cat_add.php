<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Adver/cat_modify')}" frame="true" refresh="true">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">分类标识</th>
				<td><input type="text" class="input fl" name="cat_key" size="10" placeholder="分类标识" validate="maxlength:20,required:true,english:true" tips="如果是团购分类头部展示的广告，请填写<br/> cat_(分类ID)_top"/></td>
			</tr>
		</table>
