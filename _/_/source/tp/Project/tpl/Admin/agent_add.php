...
<form id="myform" method="post" action="{pigcms{:U('Admin/agent_add')}" enctype="multipart/form-data">
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
        ...
        <tr>
            <th width="15%">照片</th>
            <td width="70%" colspan="3"><input type="file" class="input fl" name="pic" style="width:200px;"></td>
        </tr>
	</table>
