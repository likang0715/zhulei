...
$(function(){
	...
	if ($(".js-regions-wrap").data("city") != '') {
		$("select[name=city]").attr("disabled", "disabled").css({ color:'#ccc', backgroundColor:'#fafafa', boxShadow:'none' });
	}
	...
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		...
		<tr>
			...
			<td width="85%" colspan="3">
				<input type="hidden" name="area_level" value="3">
				<div class="area_select js-regions-wrap" data-province="{pigcms{$admin_user['province']}" data-city="{pigcms{$admin_user['city']}">
					...
					<span><select name="county" id="s3" validate="required:true"><option value="">选择区县</option></select></span>
				</div>
			</td>
		</tr>
		<tr>
