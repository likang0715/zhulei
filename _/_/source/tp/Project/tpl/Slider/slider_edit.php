	...
	<form id="myform" method="post" action="{pigcms{:U('Slider/slider_amend')}" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<if condition="$now_slider['pic']">
				<tr>
					<th width="80">导航现图</th>
					<td><img src="{pigcms{$now_slider.pic}" style="width:80px;height:80px;" class="view_msg"/></td>
				</tr>
			</if>
			<tr>
				<th width="80">导航图片</th>
			...
			<tr>
				<th width="80">导航排序</th>
				<td><input type="text" class="input fl" name="sort" value="{pigcms{$now_slider.sort}" style="width:80px;" value="0" validate="maxlength:10,required:true,number:true"/></td>
			</tr>			
			<tr>
				<th width="80">导航状态</th>
				<td>
